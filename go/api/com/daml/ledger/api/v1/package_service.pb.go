...
const file_com_daml_ledger_api_v1_package_service_proto_rawDesc = "" +
	...
	"\x10GetPackageStatus\x12/.com.daml.ledger.api.v1.GetPackageStatusRequest\x1a0.com.daml.ledger.api.v1.GetPackageStatusResponseB\x92\x01\n" +
	"\x16com.daml.ledger.api.v1B\x18PackageServiceOuterClassZEgithub.com/digital-asset/dazl-client/v8/go/api/com/daml/ledger/api/v1\xaa\x02\x16Com.Daml.Ledger.Api.V1b\x06proto3"
