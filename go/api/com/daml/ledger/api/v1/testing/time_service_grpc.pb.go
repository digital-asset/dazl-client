...
type TimeServiceClient interface {
	GetTime(ctx context.Context, in *GetTimeRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[GetTimeResponse], error)
...
func (c *timeServiceClient) GetTime(ctx context.Context, in *GetTimeRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[GetTimeResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &TimeService_ServiceDesc.Streams[0], TimeService_GetTime_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[GetTimeRequest, GetTimeResponse]{ClientStream: stream}
...
type TimeService_GetTimeClient = grpc.ServerStreamingClient[GetTimeResponse]
...
type TimeServiceServer interface {
	GetTime(*GetTimeRequest, grpc.ServerStreamingServer[GetTimeResponse]) error
...
func (UnimplementedTimeServiceServer) GetTime(*GetTimeRequest, grpc.ServerStreamingServer[GetTimeResponse]) error {
...
func _TimeService_GetTime_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(TimeServiceServer).GetTime(m, &grpc.GenericServerStream[GetTimeRequest, GetTimeResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type TimeService_GetTimeServer = grpc.ServerStreamingServer[GetTimeResponse]
