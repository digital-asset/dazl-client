...
const file_com_daml_ledger_api_v1_admin_metering_report_service_proto_rawDesc = "" +
	"\n" +
	":com/daml/ledger/api/v1/admin/metering_report_service.proto\x12\x1ccom.daml.ledger.api.v1.admin\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1cgoogle/protobuf/struct.proto\"\x9d\x01\n" +
	"\x18GetMeteringReportRequest\x12.\n" +
	"\x04from\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\x04from\x12*\n" +
	"\x02to\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\x02to\x12%\n" +
	"\x0eapplication_id\x18\x03 \x01(\tR\rapplicationId\"\xa4\x02\n" +
	"\x19GetMeteringReportResponse\x12P\n" +
	"\arequest\x18\x01 \x01(\v26.com.daml.ledger.api.v1.admin.GetMeteringReportRequestR\arequest\x12P\n" +
	"\x16report_generation_time\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\x14reportGenerationTime\x12I\n" +
	"\x14metering_report_json\x18\x04 \x01(\v2\x17.google.protobuf.StructR\x12meteringReportJsonJ\x04\b\x02\x10\x03R\x12participant_report2\x9e\x01\n" +
	"\x15MeteringReportService\x12\x84\x01\n" +
	"\x11GetMeteringReport\x126.com.daml.ledger.api.v1.admin.GetMeteringReportRequest\x1a7.com.daml.ledger.api.v1.admin.GetMeteringReportResponseB\xa4\x01\n" +
	"\x1ccom.daml.ledger.api.v1.adminB\x18MeteringReportOuterClassZKgithub.com/digital-asset/dazl-client/v8/go/api/com/daml/ledger/api/v1/admin\xaa\x02\x1cCom.Daml.Ledger.Api.V1.Adminb\x06proto3"

var (
	file_com_daml_ledger_api_v1_admin_metering_report_service_proto_rawDescOnce sync.Once
	file_com_daml_ledger_api_v1_admin_metering_report_service_proto_rawDescData []byte
)
...
func file_com_daml_ledger_api_v1_admin_metering_report_service_proto_rawDescGZIP() []byte {
	file_com_daml_ledger_api_v1_admin_metering_report_service_proto_rawDescOnce.Do(func() {
		file_com_daml_ledger_api_v1_admin_metering_report_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_com_daml_ledger_api_v1_admin_metering_report_service_proto_rawDesc), len(file_com_daml_ledger_api_v1_admin_metering_report_service_proto_rawDesc)))
	})
...
func file_com_daml_ledger_api_v1_admin_metering_report_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_com_daml_ledger_api_v1_admin_metering_report_service_proto_rawDesc), len(file_com_daml_ledger_api_v1_admin_metering_report_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
