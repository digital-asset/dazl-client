...
func file_com_daml_ledger_api_v1_admin_package_management_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_com_daml_ledger_api_v1_admin_package_management_service_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_daml_ledger_api_v1_admin_package_management_service_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
