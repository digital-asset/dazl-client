...
const file_com_daml_ledger_api_v1_admin_identity_provider_config_service_proto_rawDesc = "" +
	"\n" +
	"Ccom/daml/ledger/api/v1/admin/identity_provider_config_service.proto\x12\x1ccom.daml.ledger.api.v1.admin\x1a google/protobuf/field_mask.proto\"\xc0\x01\n" +
	...
	"\x18identity_provider_config\x18\x01 \x01(\v24.com.daml.ledger.api.v1.admin.IdentityProviderConfigR\x16identityProviderConfig\"\x96\x01\n" +
	"$CreateIdentityProviderConfigResponse\x12n\n" +
	"\x18identity_provider_config\x18\x01 \x01(\v24.com.daml.ledger.api.v1.admin.IdentityProviderConfigR\x16identityProviderConfig\"T\n" +
	...
	"\x18identity_provider_config\x18\x01 \x01(\v24.com.daml.ledger.api.v1.admin.IdentityProviderConfigR\x16identityProviderConfig\"$\n" +
	"\"ListIdentityProviderConfigsRequest\"\x97\x01\n" +
	"#ListIdentityProviderConfigsResponse\x12p\n" +
	"\x19identity_provider_configs\x18\x01 \x03(\v24.com.daml.ledger.api.v1.admin.IdentityProviderConfigR\x17identityProviderConfigs\"\xd2\x01\n" +
	"#UpdateIdentityProviderConfigRequest\x12n\n" +
	"\x18identity_provider_config\x18\x01 \x01(\v24.com.daml.ledger.api.v1.admin.IdentityProviderConfigR\x16identityProviderConfig\x12;\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskR\n" +
	"updateMask\"\x96\x01\n" +
	"$UpdateIdentityProviderConfigResponse\x12n\n" +
	"\x18identity_provider_config\x18\x01 \x01(\v24.com.daml.ledger.api.v1.admin.IdentityProviderConfigR\x16identityProviderConfig\"W\n" +
	...
	"\x1cCreateIdentityProviderConfig\x12A.com.daml.ledger.api.v1.admin.CreateIdentityProviderConfigRequest\x1aB.com.daml.ledger.api.v1.admin.CreateIdentityProviderConfigResponse\x12\x9c\x01\n" +
	...
	"\x1cUpdateIdentityProviderConfig\x12A.com.daml.ledger.api.v1.admin.UpdateIdentityProviderConfigRequest\x1aB.com.daml.ledger.api.v1.admin.UpdateIdentityProviderConfigResponse\x12\xa2\x01\n" +
	"\x1bListIdentityProviderConfigs\x12@.com.daml.ledger.api.v1.admin.ListIdentityProviderConfigsRequest\x1aA.com.daml.ledger.api.v1.admin.ListIdentityProviderConfigsResponse\x12\xa5\x01\n" +
	"\x1cDeleteIdentityProviderConfig\x12A.com.daml.ledger.api.v1.admin.DeleteIdentityProviderConfigRequest\x1aB.com.daml.ledger.api.v1.admin.DeleteIdentityProviderConfigResponseB\xb3\x01\n" +
	"\x1ccom.daml.ledger.api.v1.adminB'IdentityProviderConfigServiceOuterClassZKgithub.com/digital-asset/dazl-client/v8/go/api/com/daml/ledger/api/v1/admin\xaa\x02\x1cCom.Daml.Ledger.Api.V1.Adminb\x06proto3"

var (
	file_com_daml_ledger_api_v1_admin_identity_provider_config_service_proto_rawDescOnce sync.Once
	file_com_daml_ledger_api_v1_admin_identity_provider_config_service_proto_rawDescData []byte
)
...
func file_com_daml_ledger_api_v1_admin_identity_provider_config_service_proto_rawDescGZIP() []byte {
	file_com_daml_ledger_api_v1_admin_identity_provider_config_service_proto_rawDescOnce.Do(func() {
		file_com_daml_ledger_api_v1_admin_identity_provider_config_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_com_daml_ledger_api_v1_admin_identity_provider_config_service_proto_rawDesc), len(file_com_daml_ledger_api_v1_admin_identity_provider_config_service_proto_rawDesc)))
	})
...
var file_com_daml_ledger_api_v1_admin_identity_provider_config_service_proto_goTypes = []any{
...
func file_com_daml_ledger_api_v1_admin_identity_provider_config_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_com_daml_ledger_api_v1_admin_identity_provider_config_service_proto_rawDesc), len(file_com_daml_ledger_api_v1_admin_identity_provider_config_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   11,
			NumExtensions: 0,
			NumServices:   1,
