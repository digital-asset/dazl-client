...
const file_com_daml_ledger_api_v1_admin_command_inspection_service_proto_rawDesc = "" +
	"\n" +
	"=com/daml/ledger/api/v1/admin/command_inspection_service.proto\x12\x1ccom.daml.ledger.api.v1.admin\x1a\"com/daml/ledger/api/v1/value.proto\x1a%com/daml/ledger/api/v1/commands.proto\x1a'com/daml/ledger/api/v1/completion.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x9d\x01\n" +
	"\x17GetCommandStatusRequest\x12*\n" +
	"\x11command_id_prefix\x18\x01 \x01(\tR\x0fcommandIdPrefix\x12@\n" +
	"\x05state\x18\x02 \x01(\x0e2*.com.daml.ledger.api.v1.admin.CommandStateR\x05state\x12\x14\n" +
	"\x05limit\x18\x03 \x01(\rR\x05limit\"\xd4\n" +
	"\n" +
	"\x18GetCommandStatusResponse\x12k\n" +
	"\x0ecommand_status\x18\x01 \x03(\v2D.com.daml.ledger.api.v1.admin.GetCommandStatusResponse.CommandStatusR\rcommandStatus\x1a\xca\t\n" +
	"\rCommandStatus\x124\n" +
	...
	"\n" +
	"completion\x18\x03 \x01(\v2\".com.daml.ledger.api.v1.CompletionR\n" +
	"completion\x12@\n" +
	"\x05state\x18\x04 \x01(\x0e2*.com.daml.ledger.api.v1.admin.CommandStateR\x05state\x12;\n" +
	"\bcommands\x18\x05 \x03(\v2\x1f.com.daml.ledger.api.v1.CommandR\bcommands\x12\x85\x01\n" +
	"\x12request_statistics\x18\x06 \x01(\v2V.com.daml.ledger.api.v1.admin.GetCommandStatusResponse.CommandStatus.RequestStatisticsR\x11requestStatistics\x12m\n" +
	"\aupdates\x18\a \x01(\v2S.com.daml.ledger.api.v1.admin.GetCommandStatusResponse.CommandStatus.CommandUpdatesR\aupdates\x1at\n" +
	...
	"\x0eCommandUpdates\x12v\n" +
	"\acreated\x18\x01 \x03(\v2\\.com.daml.ledger.api.v1.admin.GetCommandStatusResponse.CommandStatus.CommandUpdates.ContractR\acreated\x12x\n" +
	"\barchived\x18\x02 \x03(\v2\\.com.daml.ledger.api.v1.admin.GetCommandStatusResponse.CommandStatus.CommandUpdates.ContractR\barchived\x12\x1c\n" +
	...
	"contractId\x12@\n" +
	"\fcontract_key\x18\x03 \x01(\v2\x1d.com.daml.ledger.api.v1.ValueR\vcontractKey*_\n" +
	"\fCommandState\x12\x15\n" +
	"\x11STATE_UNSPECIFIED\x10\x00\x12\x11\n" +
	"\rSTATE_PENDING\x10\x01\x12\x13\n" +
	"\x0fSTATE_SUCCEEDED\x10\x02\x12\x10\n" +
	"\fSTATE_FAILED\x10\x032\x9e\x01\n" +
	"\x18CommandInspectionService\x12\x81\x01\n" +
	"\x10GetCommandStatus\x125.com.daml.ledger.api.v1.admin.GetCommandStatusRequest\x1a6.com.daml.ledger.api.v1.admin.GetCommandStatusResponseB\xae\x01\n" +
	"\x1ccom.daml.ledger.api.v1.adminB\"CommandInspectionServiceOuterClassZKgithub.com/digital-asset/dazl-client/v8/go/api/com/daml/ledger/api/v1/admin\xaa\x02\x1cCom.Daml.Ledger.Api.V1.Adminb\x06proto3"

var (
	file_com_daml_ledger_api_v1_admin_command_inspection_service_proto_rawDescOnce sync.Once
	file_com_daml_ledger_api_v1_admin_command_inspection_service_proto_rawDescData []byte
)
...
func file_com_daml_ledger_api_v1_admin_command_inspection_service_proto_rawDescGZIP() []byte {
	file_com_daml_ledger_api_v1_admin_command_inspection_service_proto_rawDescOnce.Do(func() {
		file_com_daml_ledger_api_v1_admin_command_inspection_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_com_daml_ledger_api_v1_admin_command_inspection_service_proto_rawDesc), len(file_com_daml_ledger_api_v1_admin_command_inspection_service_proto_rawDesc)))
	})
...
func file_com_daml_ledger_api_v1_admin_command_inspection_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_com_daml_ledger_api_v1_admin_command_inspection_service_proto_rawDesc), len(file_com_daml_ledger_api_v1_admin_command_inspection_service_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
