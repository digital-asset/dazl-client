...
var file_com_daml_ledger_api_v1_admin_command_inspection_service_proto_goTypes = []interface{}{
...
func file_com_daml_ledger_api_v1_admin_command_inspection_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_daml_ledger_api_v1_admin_command_inspection_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_daml_ledger_api_v1_admin_command_inspection_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_daml_ledger_api_v1_admin_command_inspection_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetCommandStatusResponse_CommandStatus); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_com_daml_ledger_api_v1_admin_command_inspection_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetCommandStatusResponse_CommandStatus_RequestStatistics); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_com_daml_ledger_api_v1_admin_command_inspection_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetCommandStatusResponse_CommandStatus_CommandUpdates); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_com_daml_ledger_api_v1_admin_command_inspection_service_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetCommandStatusResponse_CommandStatus_CommandUpdates_Contract); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
