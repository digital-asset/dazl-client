...
const file_com_daml_ledger_api_v1_admin_participant_pruning_service_proto_rawDesc = "" +
	"\n" +
	">com/daml/ledger/api/v1/admin/participant_pruning_service.proto\x12\x1ccom.daml.ledger.api.v1.admin\"\x94\x01\n" +
	"\fPruneRequest\x12\x1e\n" +
	"\vprune_up_to\x18\x01 \x01(\tR\tpruneUpTo\x12#\n" +
	...
	"\x1ccom.daml.ledger.api.v1.adminB#ParticipantPruningServiceOuterClassZKgithub.com/digital-asset/dazl-client/v8/go/api/com/daml/ledger/api/v1/admin\xaa\x02\x1cCom.Daml.Ledger.Api.V1.Adminb\x06proto3"

var (
	file_com_daml_ledger_api_v1_admin_participant_pruning_service_proto_rawDescOnce sync.Once
	file_com_daml_ledger_api_v1_admin_participant_pruning_service_proto_rawDescData []byte
)
...
func file_com_daml_ledger_api_v1_admin_participant_pruning_service_proto_rawDescGZIP() []byte {
	file_com_daml_ledger_api_v1_admin_participant_pruning_service_proto_rawDescOnce.Do(func() {
		file_com_daml_ledger_api_v1_admin_participant_pruning_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_com_daml_ledger_api_v1_admin_participant_pruning_service_proto_rawDesc), len(file_com_daml_ledger_api_v1_admin_participant_pruning_service_proto_rawDesc)))
	})
...
func file_com_daml_ledger_api_v1_admin_participant_pruning_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_com_daml_ledger_api_v1_admin_participant_pruning_service_proto_rawDesc), len(file_com_daml_ledger_api_v1_admin_participant_pruning_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
