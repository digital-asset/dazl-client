...
var file_com_daml_ledger_api_v2_admin_participant_pruning_service_proto_rawDesc = []byte{
	...
	0x72, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x32, 0x2e, 0x61, 0x64, 0x6d, 0x69, 0x6e, 0x22, 0x94,
	...
	0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x70, 0x72, 0x75, 0x6e, 0x65, 0x55, 0x70, 0x54, 0x6f, 0x12,
	...
	0x70, 0x69, 0x2e, 0x76, 0x32, 0x2e, 0x61, 0x64, 0x6d, 0x69, 0x6e, 0x2e, 0x50, 0x72, 0x75, 0x6e,
	...
	0x32, 0x2e, 0x61, 0x64, 0x6d, 0x69, 0x6e, 0x2e, 0x50, 0x72, 0x75, 0x6e, 0x65, 0x52, 0x65, 0x73,
...
var (
	...
	file_com_daml_ledger_api_v2_admin_participant_pruning_service_proto_rawDescData = file_com_daml_ledger_api_v2_admin_participant_pruning_service_proto_rawDesc
)
...
func file_com_daml_ledger_api_v2_admin_participant_pruning_service_proto_rawDescGZIP() []byte {
	file_com_daml_ledger_api_v2_admin_participant_pruning_service_proto_rawDescOnce.Do(func() {
		file_com_daml_ledger_api_v2_admin_participant_pruning_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_com_daml_ledger_api_v2_admin_participant_pruning_service_proto_rawDescData)
	})
...
func file_com_daml_ledger_api_v2_admin_participant_pruning_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_daml_ledger_api_v2_admin_participant_pruning_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_com_daml_ledger_api_v2_admin_participant_pruning_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_com_daml_ledger_api_v2_admin_participant_pruning_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_com_daml_ledger_api_v2_admin_participant_pruning_service_proto_rawDesc = nil
