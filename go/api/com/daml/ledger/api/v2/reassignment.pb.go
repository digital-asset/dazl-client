...
func file_com_daml_ledger_api_v2_reassignment_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_daml_ledger_api_v2_reassignment_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Reassignment); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_com_daml_ledger_api_v2_reassignment_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*UnassignedEvent); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_com_daml_ledger_api_v2_reassignment_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*AssignedEvent); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
