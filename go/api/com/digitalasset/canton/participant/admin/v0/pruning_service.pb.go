...
var file_com_digitalasset_canton_participant_admin_v0_pruning_service_proto_rawDesc = []byte{
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0xa3, 0x09, 0x0a, 0x0e, 0x50, 0x72, 0x75, 0x6e, 0x69,
...
var file_com_digitalasset_canton_participant_admin_v0_pruning_service_proto_goTypes = []interface{}{
	...
	(*v0.SetCron_Request)(nil),                               // 7: com.digitalasset.canton.pruning.admin.v0.SetCron.Request
	(*v0.SetMaxDuration_Request)(nil),                        // 8: com.digitalasset.canton.pruning.admin.v0.SetMaxDuration.Request
	(*v0.SetRetention_Request)(nil),                          // 9: com.digitalasset.canton.pruning.admin.v0.SetRetention.Request
	(*v0.ClearSchedule_Request)(nil),                         // 10: com.digitalasset.canton.pruning.admin.v0.ClearSchedule.Request
	(*v0.GetSchedule_Request)(nil),                           // 11: com.digitalasset.canton.pruning.admin.v0.GetSchedule.Request
	(*v0.SetSchedule_Response)(nil),                          // 12: com.digitalasset.canton.pruning.admin.v0.SetSchedule.Response
	(*v0.SetCron_Response)(nil),                              // 13: com.digitalasset.canton.pruning.admin.v0.SetCron.Response
	(*v0.SetMaxDuration_Response)(nil),                       // 14: com.digitalasset.canton.pruning.admin.v0.SetMaxDuration.Response
	(*v0.SetRetention_Response)(nil),                         // 15: com.digitalasset.canton.pruning.admin.v0.SetRetention.Response
	(*v0.ClearSchedule_Response)(nil),                        // 16: com.digitalasset.canton.pruning.admin.v0.ClearSchedule.Response
	(*v0.GetSchedule_Response)(nil),                          // 17: com.digitalasset.canton.pruning.admin.v0.GetSchedule.Response
}
var file_com_digitalasset_canton_participant_admin_v0_pruning_service_proto_depIdxs = []int32{
	...
	7,  // 5: com.digitalasset.canton.participant.admin.v0.PruningService.SetCron:input_type -> com.digitalasset.canton.pruning.admin.v0.SetCron.Request
	8,  // 6: com.digitalasset.canton.participant.admin.v0.PruningService.SetMaxDuration:input_type -> com.digitalasset.canton.pruning.admin.v0.SetMaxDuration.Request
	9,  // 7: com.digitalasset.canton.participant.admin.v0.PruningService.SetRetention:input_type -> com.digitalasset.canton.pruning.admin.v0.SetRetention.Request
	10, // 8: com.digitalasset.canton.participant.admin.v0.PruningService.ClearSchedule:input_type -> com.digitalasset.canton.pruning.admin.v0.ClearSchedule.Request
	11, // 9: com.digitalasset.canton.participant.admin.v0.PruningService.GetSchedule:input_type -> com.digitalasset.canton.pruning.admin.v0.GetSchedule.Request
	1,  // 10: com.digitalasset.canton.participant.admin.v0.PruningService.Prune:output_type -> com.digitalasset.canton.participant.admin.v0.PruneResponse
	3,  // 11: com.digitalasset.canton.participant.admin.v0.PruningService.GetSafePruningOffset:output_type -> com.digitalasset.canton.participant.admin.v0.GetSafePruningOffsetResponse
	12, // 12: com.digitalasset.canton.participant.admin.v0.PruningService.SetSchedule:output_type -> com.digitalasset.canton.pruning.admin.v0.SetSchedule.Response
	13, // 13: com.digitalasset.canton.participant.admin.v0.PruningService.SetCron:output_type -> com.digitalasset.canton.pruning.admin.v0.SetCron.Response
	14, // 14: com.digitalasset.canton.participant.admin.v0.PruningService.SetMaxDuration:output_type -> com.digitalasset.canton.pruning.admin.v0.SetMaxDuration.Response
	15, // 15: com.digitalasset.canton.participant.admin.v0.PruningService.SetRetention:output_type -> com.digitalasset.canton.pruning.admin.v0.SetRetention.Response
	16, // 16: com.digitalasset.canton.participant.admin.v0.PruningService.ClearSchedule:output_type -> com.digitalasset.canton.pruning.admin.v0.ClearSchedule.Response
	17, // 17: com.digitalasset.canton.participant.admin.v0.PruningService.GetSchedule:output_type -> com.digitalasset.canton.pruning.admin.v0.GetSchedule.Response
...
func file_com_digitalasset_canton_participant_admin_v0_pruning_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_digitalasset_canton_participant_admin_v0_pruning_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_digitalasset_canton_participant_admin_v0_pruning_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_digitalasset_canton_participant_admin_v0_pruning_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetSafePruningOffsetRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_com_digitalasset_canton_participant_admin_v0_pruning_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetSafePruningOffsetResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_com_digitalasset_canton_participant_admin_v0_pruning_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetSafePruningOffsetResponse_NoSafePruningOffset); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_com_digitalasset_canton_participant_admin_v0_pruning_service_proto_msgTypes[3].OneofWrappers = []interface{}{
