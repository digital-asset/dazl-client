...
func file_com_digitalasset_canton_participant_protocol_v0_submission_tracking_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_digitalasset_canton_participant_protocol_v0_submission_tracking_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_com_digitalasset_canton_participant_protocol_v0_submission_tracking_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_com_digitalasset_canton_participant_protocol_v0_submission_tracking_proto_msgTypes[2].Exporter = func(v any, i int) any {
