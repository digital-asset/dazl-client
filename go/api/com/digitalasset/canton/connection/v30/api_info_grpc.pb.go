...
const (
	ApiInfoService_GetApiInfo_FullMethodName = "/com.digitalasset.canton.connection.v30.ApiInfoService/GetApiInfo"
)
...
func (c *apiInfoServiceClient) GetApiInfo(ctx context.Context, in *GetApiInfoRequest, opts ...grpc.CallOption) (*GetApiInfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, ApiInfoService_GetApiInfo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ApiInfoService_GetApiInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ApiInfoService_GetApiInfo_FullMethodName,
	}
