...
var file_com_digitalasset_canton_time_admin_v0_time_tracker_config_proto_goTypes = []interface{}{
...
func file_com_digitalasset_canton_time_admin_v0_time_tracker_config_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_digitalasset_canton_time_admin_v0_time_tracker_config_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_digitalasset_canton_time_admin_v0_time_tracker_config_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
