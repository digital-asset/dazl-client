...
func (c *mediatorInitializationServiceClient) InitializeMediator(ctx context.Context, in *InitializeMediatorRequest, opts ...grpc.CallOption) (*InitializeMediatorResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(InitializeMediatorResponse)
	err := c.cc.Invoke(ctx, MediatorInitializationService_InitializeMediator_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMediatorInitializationServiceServer) InitializeMediator(context.Context, *InitializeMediatorRequest) (*InitializeMediatorResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method InitializeMediator not implemented")
}
...
func _MediatorInitializationService_InitializeMediator_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(InitializeMediatorRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MediatorInitializationServiceServer).InitializeMediator(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MediatorInitializationService_InitializeMediator_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MediatorInitializationServiceServer).InitializeMediator(ctx, req.(*InitializeMediatorRequest))
	}
