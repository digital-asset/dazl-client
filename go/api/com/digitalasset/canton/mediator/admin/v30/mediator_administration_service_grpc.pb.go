...
const (
	...
	MediatorAdministrationService_FindPruningTimestamp_FullMethodName = "/com.digitalasset.canton.mediator.admin.v30.MediatorAdministrationService/FindPruningTimestamp"
)
...
func (c *mediatorAdministrationServiceClient) FindPruningTimestamp(ctx context.Context, in *v30.FindPruningTimestampRequest, opts ...grpc.CallOption) (*v30.FindPruningTimestampResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(v30.FindPruningTimestampResponse)
	err := c.cc.Invoke(ctx, MediatorAdministrationService_FindPruningTimestamp_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMediatorAdministrationServiceServer) FindPruningTimestamp(context.Context, *v30.FindPruningTimestampRequest) (*v30.FindPruningTimestampResponse, error) {
...
func _MediatorAdministrationService_FindPruningTimestamp_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(v30.FindPruningTimestampRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MediatorAdministrationServiceServer).FindPruningTimestamp(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MediatorAdministrationService_FindPruningTimestamp_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MediatorAdministrationServiceServer).FindPruningTimestamp(ctx, req.(*v30.FindPruningTimestampRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MediatorAdministrationService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _MediatorAdministrationService_FindPruningTimestamp_Handler,
		},
	},
