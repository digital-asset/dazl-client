...
func (c *sequencerPruningAdministrationServiceClient) LocatePruningTimestamp(ctx context.Context, in *v30.LocatePruningTimestampRequest, opts ...grpc.CallOption) (*v30.LocatePruningTimestampResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedSequencerPruningAdministrationServiceServer) LocatePruningTimestamp(context.Context, *v30.LocatePruningTimestampRequest) (*v30.LocatePruningTimestampResponse, error) {
...
func _SequencerPruningAdministrationService_LocatePruningTimestamp_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SequencerPruningAdministrationServiceServer).LocatePruningTimestamp(ctx, req.(*v30.LocatePruningTimestampRequest))
	}
	return interceptor(ctx, in, info, handler)
}
