...
func (c *sequencerBftAdministrationServiceClient) SetPerformanceMetricsEnabled(ctx context.Context, in *SetPerformanceMetricsEnabledRequest, opts ...grpc.CallOption) (*SetPerformanceMetricsEnabledResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SetPerformanceMetricsEnabledResponse)
	err := c.cc.Invoke(ctx, SequencerBftAdministrationService_SetPerformanceMetricsEnabled_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedSequencerBftAdministrationServiceServer) SetPerformanceMetricsEnabled(context.Context, *SetPerformanceMetricsEnabledRequest) (*SetPerformanceMetricsEnabledResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SetPerformanceMetricsEnabled not implemented")
}
...
func _SequencerBftAdministrationService_SetPerformanceMetricsEnabled_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetPerformanceMetricsEnabledRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SequencerBftAdministrationServiceServer).SetPerformanceMetricsEnabled(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SequencerBftAdministrationService_SetPerformanceMetricsEnabled_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SequencerBftAdministrationServiceServer).SetPerformanceMetricsEnabled(ctx, req.(*SetPerformanceMetricsEnabledRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SequencerBftAdministrationService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SetPerformanceMetricsEnabled",
			Handler:    _SequencerBftAdministrationService_SetPerformanceMetricsEnabled_Handler,
		},
	},
