...
const (
	VaultService_ListMyKeys_FullMethodName               = "/com.digitalasset.canton.crypto.admin.v30.VaultService/ListMyKeys"
	VaultService_GenerateSigningKey_FullMethodName       = "/com.digitalasset.canton.crypto.admin.v30.VaultService/GenerateSigningKey"
	VaultService_GenerateEncryptionKey_FullMethodName    = "/com.digitalasset.canton.crypto.admin.v30.VaultService/GenerateEncryptionKey"
	VaultService_RegisterKmsEncryptionKey_FullMethodName = "/com.digitalasset.canton.crypto.admin.v30.VaultService/RegisterKmsEncryptionKey"
	VaultService_RegisterKmsSigningKey_FullMethodName    = "/com.digitalasset.canton.crypto.admin.v30.VaultService/RegisterKmsSigningKey"
	VaultService_ImportPublicKey_FullMethodName          = "/com.digitalasset.canton.crypto.admin.v30.VaultService/ImportPublicKey"
	VaultService_ListPublicKeys_FullMethodName           = "/com.digitalasset.canton.crypto.admin.v30.VaultService/ListPublicKeys"
	VaultService_RotateWrapperKey_FullMethodName         = "/com.digitalasset.canton.crypto.admin.v30.VaultService/RotateWrapperKey"
	VaultService_GetWrapperKeyId_FullMethodName          = "/com.digitalasset.canton.crypto.admin.v30.VaultService/GetWrapperKeyId"
	VaultService_ExportKeyPair_FullMethodName            = "/com.digitalasset.canton.crypto.admin.v30.VaultService/ExportKeyPair"
	VaultService_ImportKeyPair_FullMethodName            = "/com.digitalasset.canton.crypto.admin.v30.VaultService/ImportKeyPair"
	VaultService_DeleteKeyPair_FullMethodName            = "/com.digitalasset.canton.crypto.admin.v30.VaultService/DeleteKeyPair"
)
...
type VaultServiceClient interface {
	ListMyKeys(ctx context.Context, in *ListMyKeysRequest, opts ...grpc.CallOption) (*ListMyKeysResponse, error)
	...
	RotateWrapperKey(ctx context.Context, in *RotateWrapperKeyRequest, opts ...grpc.CallOption) (*RotateWrapperKeyResponse, error)
...
func (c *vaultServiceClient) ListMyKeys(ctx context.Context, in *ListMyKeysRequest, opts ...grpc.CallOption) (*ListMyKeysResponse, error) {
...
func (c *vaultServiceClient) ListPublicKeys(ctx context.Context, in *ListPublicKeysRequest, opts ...grpc.CallOption) (*ListPublicKeysResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *vaultServiceClient) RotateWrapperKey(ctx context.Context, in *RotateWrapperKeyRequest, opts ...grpc.CallOption) (*RotateWrapperKeyResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RotateWrapperKeyResponse)
...
type VaultServiceServer interface {
	ListMyKeys(context.Context, *ListMyKeysRequest) (*ListMyKeysResponse, error)
	...
	RotateWrapperKey(context.Context, *RotateWrapperKeyRequest) (*RotateWrapperKeyResponse, error)
...
func (UnimplementedVaultServiceServer) ListMyKeys(context.Context, *ListMyKeysRequest) (*ListMyKeysResponse, error) {
...
func (UnimplementedVaultServiceServer) ListPublicKeys(context.Context, *ListPublicKeysRequest) (*ListPublicKeysResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListPublicKeys not implemented")
}
func (UnimplementedVaultServiceServer) RotateWrapperKey(context.Context, *RotateWrapperKeyRequest) (*RotateWrapperKeyResponse, error) {
...
func _VaultService_ListMyKeys_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VaultServiceServer).ListMyKeys(ctx, req.(*ListMyKeysRequest))
	}
...
func _VaultService_ListPublicKeys_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VaultServiceServer).ListPublicKeys(ctx, req.(*ListPublicKeysRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var VaultService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "com.digitalasset.canton.crypto.admin.v30.VaultService",
	...
	Metadata: "com/digitalasset/canton/crypto/admin/v30/vault_service.proto",
}
