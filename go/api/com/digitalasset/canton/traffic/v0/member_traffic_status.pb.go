...
func file_com_digitalasset_canton_traffic_v0_member_traffic_status_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_digitalasset_canton_traffic_v0_member_traffic_status_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_com_digitalasset_canton_traffic_v0_member_traffic_status_proto_msgTypes[1].Exporter = func(v any, i int) any {
