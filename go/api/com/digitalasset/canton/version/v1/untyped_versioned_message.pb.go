...
const file_com_digitalasset_canton_version_v1_untyped_versioned_message_proto_rawDesc = "" +
	"\n" +
	...
	"\awrapperBSZQgithub.com/digital-asset/dazl-client/v8/go/api/com/digitalasset/canton/version/v1b\x06proto3"

var (
	file_com_digitalasset_canton_version_v1_untyped_versioned_message_proto_rawDescOnce sync.Once
	file_com_digitalasset_canton_version_v1_untyped_versioned_message_proto_rawDescData []byte
)
...
func file_com_digitalasset_canton_version_v1_untyped_versioned_message_proto_rawDescGZIP() []byte {
	file_com_digitalasset_canton_version_v1_untyped_versioned_message_proto_rawDescOnce.Do(func() {
		file_com_digitalasset_canton_version_v1_untyped_versioned_message_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_com_digitalasset_canton_version_v1_untyped_versioned_message_proto_rawDesc), len(file_com_digitalasset_canton_version_v1_untyped_versioned_message_proto_rawDesc)))
	})
...
func file_com_digitalasset_canton_version_v1_untyped_versioned_message_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_com_digitalasset_canton_version_v1_untyped_versioned_message_proto_rawDesc), len(file_com_digitalasset_canton_version_v1_untyped_versioned_message_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
