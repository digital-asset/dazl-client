...
func file_com_digitalasset_canton_protocol_v2_domain_params_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_digitalasset_canton_protocol_v2_domain_params_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*CatchUpConfig); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_com_digitalasset_canton_protocol_v2_domain_params_proto_msgTypes[1].Exporter = func(v any, i int) any {
