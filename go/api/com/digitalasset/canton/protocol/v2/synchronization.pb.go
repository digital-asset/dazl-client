...
const file_com_digitalasset_canton_protocol_v2_synchronization_proto_rawDesc = "" +
	"\n" +
	"9com/digitalasset/canton/protocol/v2/synchronization.proto\x12#com.digitalasset.canton.protocol.v2\x1aAcom/digitalasset/canton/protocol/v0/participant_transaction.proto\x1a9com/digitalasset/canton/protocol/v0/synchronization.proto\x1a2com/digitalasset/canton/protocol/v0/topology.proto\x1aAcom/digitalasset/canton/protocol/v1/participant_transaction.proto\x1a>com/digitalasset/canton/protocol/v1/participant_transfer.proto\x1a2com/digitalasset/canton/protocol/v1/topology.proto\"\xae\t\n" +
	...
	"\x16encrypted_view_message\x18\x03 \x01(\v29.com.digitalasset.canton.protocol.v1.EncryptedViewMessageH\x00R\x14encryptedViewMessage\x12\x96\x01\n" +
	...
	"\x15some_envelope_contentBTZRgithub.com/digital-asset/dazl-client/v8/go/api/com/digitalasset/canton/protocol/v2b\x06proto3"

var (
	file_com_digitalasset_canton_protocol_v2_synchronization_proto_rawDescOnce sync.Once
	file_com_digitalasset_canton_protocol_v2_synchronization_proto_rawDescData []byte
)
...
func file_com_digitalasset_canton_protocol_v2_synchronization_proto_rawDescGZIP() []byte {
	file_com_digitalasset_canton_protocol_v2_synchronization_proto_rawDescOnce.Do(func() {
		file_com_digitalasset_canton_protocol_v2_synchronization_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_com_digitalasset_canton_protocol_v2_synchronization_proto_rawDesc), len(file_com_digitalasset_canton_protocol_v2_synchronization_proto_rawDesc)))
	})
...
var file_com_digitalasset_canton_protocol_v2_synchronization_proto_goTypes = []any{
...
func file_com_digitalasset_canton_protocol_v2_synchronization_proto_init() {
	...
	file_com_digitalasset_canton_protocol_v2_synchronization_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_com_digitalasset_canton_protocol_v2_synchronization_proto_rawDesc), len(file_com_digitalasset_canton_protocol_v2_synchronization_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
