...
func file_com_digitalasset_canton_protocol_v2_topology_proto_init() {
	...
	file_com_digitalasset_canton_protocol_v2_topology_proto_msgTypes[1].OneofWrappers = []interface{}{
		(*DomainGovernanceTransaction_DomainParametersChange)(nil),
	}
	file_com_digitalasset_canton_protocol_v2_topology_proto_msgTypes[2].OneofWrappers = []interface{}{
