...
var file_com_digitalasset_canton_protocol_v2_common_proto_goTypes = []interface{}{
...
func file_com_digitalasset_canton_protocol_v2_common_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_digitalasset_canton_protocol_v2_common_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
