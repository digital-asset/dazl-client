...
func file_com_digitalasset_canton_protocol_v0_quorum_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_digitalasset_canton_protocol_v0_quorum_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Quorum); i {
			case 0:
				return &v.state
			case 1:
		...
		file_com_digitalasset_canton_protocol_v0_quorum_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_com_digitalasset_canton_protocol_v0_quorum_proto_msgTypes[2].Exporter = func(v any, i int) any {
