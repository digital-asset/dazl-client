...
const file_com_digitalasset_canton_protocol_v0_versioned_google_rpc_status_proto_rawDesc = "" +
	"\n" +
	...
	"\x06status\x18\x01 \x01(\v2\x12.google.rpc.StatusR\x06statusBTZRgithub.com/digital-asset/dazl-client/v8/go/api/com/digitalasset/canton/protocol/v0b\x06proto3"

var (
	file_com_digitalasset_canton_protocol_v0_versioned_google_rpc_status_proto_rawDescOnce sync.Once
	file_com_digitalasset_canton_protocol_v0_versioned_google_rpc_status_proto_rawDescData []byte
)
...
func file_com_digitalasset_canton_protocol_v0_versioned_google_rpc_status_proto_rawDescGZIP() []byte {
	file_com_digitalasset_canton_protocol_v0_versioned_google_rpc_status_proto_rawDescOnce.Do(func() {
		file_com_digitalasset_canton_protocol_v0_versioned_google_rpc_status_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_com_digitalasset_canton_protocol_v0_versioned_google_rpc_status_proto_rawDesc), len(file_com_digitalasset_canton_protocol_v0_versioned_google_rpc_status_proto_rawDesc)))
	})
...
var file_com_digitalasset_canton_protocol_v0_versioned_google_rpc_status_proto_goTypes = []any{
...
func file_com_digitalasset_canton_protocol_v0_versioned_google_rpc_status_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_com_digitalasset_canton_protocol_v0_versioned_google_rpc_status_proto_rawDesc), len(file_com_digitalasset_canton_protocol_v0_versioned_google_rpc_status_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
