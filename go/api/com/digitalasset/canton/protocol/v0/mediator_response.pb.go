...
var file_com_digitalasset_canton_protocol_v0_mediator_response_proto_goTypes = []interface{}{
...
func file_com_digitalasset_canton_protocol_v0_mediator_response_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_digitalasset_canton_protocol_v0_mediator_response_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_digitalasset_canton_protocol_v0_mediator_response_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_digitalasset_canton_protocol_v0_mediator_response_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	file_com_digitalasset_canton_protocol_v0_mediator_response_proto_msgTypes[1].OneofWrappers = []interface{}{
