...
const file_com_digitalasset_canton_protocol_v0_participant_transfer_proto_rawDesc = "" +
	"\n" +
	">com/digitalasset/canton/protocol/v0/participant_transfer.proto\x12#com.digitalasset.canton.protocol.v0\x1a.com/digitalasset/canton/crypto/v0/crypto.proto\x1a0com/digitalasset/canton/protocol/v0/common.proto\x1a0com/digitalasset/canton/protocol/v0/merkle.proto\x1a4com/digitalasset/canton/protocol/v0/sequencing.proto\x1a0com/digitalasset/canton/time/v0/time_proof.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"k\n" +
	"\n" +
	"TransferId\x12#\n" +
	"\rorigin_domain\x18\x01 \x01(\tR\foriginDomain\x128\n" +
	"\ttimestamp\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\ttimestamp\"g\n" +
	"\x1aTransferOutMediatorMessage\x12I\n" +
	"\x04tree\x18\x01 \x01(\v25.com.digitalasset.canton.protocol.v0.TransferViewTreeR\x04tree\"f\n" +
	"\x19TransferInMediatorMessage\x12I\n" +
	"\x04tree\x18\x01 \x01(\v25.com.digitalasset.canton.protocol.v0.TransferViewTreeR\x04tree\"\xc6\x01\n" +
	"\x10TransferViewTree\x12S\n" +
	"\vcommon_data\x18\x01 \x01(\v22.com.digitalasset.canton.protocol.v0.BlindableNodeR\n" +
	"commonData\x12]\n" +
	"\x10participant_data\x18\x02 \x01(\v22.com.digitalasset.canton.protocol.v0.BlindableNodeR\x0fparticipantData\"\xff\x01\n" +
	"\x15TransferOutCommonData\x12;\n" +
	"\x04salt\x18\x01 \x01(\v2'.com.digitalasset.canton.crypto.v0.SaltR\x04salt\x12#\n" +
	"\rorigin_domain\x18\x02 \x01(\tR\foriginDomain\x12\"\n" +
	...
	"\x11target_time_proof\x18\x05 \x01(\v2*.com.digitalasset.canton.time.v0.TimeProofR\x0ftargetTimeProof\"\xd9\x01\n" +
	...
	"\bcontract\x18\x03 \x01(\v29.com.digitalasset.canton.protocol.v0.SerializableContractR\bcontract\x12m\n" +
	...
	"\x17creating_transaction_id\x18\x05 \x01(\fR\x15creatingTransactionIdBTZRgithub.com/digital-asset/dazl-client/v8/go/api/com/digitalasset/canton/protocol/v0b\x06proto3"

var (
	file_com_digitalasset_canton_protocol_v0_participant_transfer_proto_rawDescOnce sync.Once
	file_com_digitalasset_canton_protocol_v0_participant_transfer_proto_rawDescData []byte
)
...
func file_com_digitalasset_canton_protocol_v0_participant_transfer_proto_rawDescGZIP() []byte {
	file_com_digitalasset_canton_protocol_v0_participant_transfer_proto_rawDescOnce.Do(func() {
		file_com_digitalasset_canton_protocol_v0_participant_transfer_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_com_digitalasset_canton_protocol_v0_participant_transfer_proto_rawDesc), len(file_com_digitalasset_canton_protocol_v0_participant_transfer_proto_rawDesc)))
	})
...
func file_com_digitalasset_canton_protocol_v0_participant_transfer_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_com_digitalasset_canton_protocol_v0_participant_transfer_proto_rawDesc), len(file_com_digitalasset_canton_protocol_v0_participant_transfer_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   0,
