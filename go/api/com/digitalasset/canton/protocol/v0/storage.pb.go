...
var file_com_digitalasset_canton_protocol_v0_storage_proto_rawDesc = []byte{
	...
	0x6f, 0x6c, 0x2f, 0x76, 0x30, 0x2f, 0x73, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x2e, 0x70, 0x72,
	...
	0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x2e, 0x76, 0x30, 0x22, 0x29, 0x0a, 0x0d, 0x53, 0x74, 0x6f, 0x72,
	0x65, 0x64, 0x50, 0x61, 0x72, 0x74, 0x69, 0x65, 0x73, 0x12, 0x18, 0x0a, 0x07, 0x70, 0x61, 0x72,
	0x74, 0x69, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x09, 0x52, 0x07, 0x70, 0x61, 0x72, 0x74,
	0x69, 0x65, 0x73, 0x42, 0x54, 0x5a, 0x52, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
...
var (
	...
	file_com_digitalasset_canton_protocol_v0_storage_proto_rawDescData = file_com_digitalasset_canton_protocol_v0_storage_proto_rawDesc
)
...
func file_com_digitalasset_canton_protocol_v0_storage_proto_rawDescGZIP() []byte {
	file_com_digitalasset_canton_protocol_v0_storage_proto_rawDescOnce.Do(func() {
		file_com_digitalasset_canton_protocol_v0_storage_proto_rawDescData = protoimpl.X.CompressGZIP(file_com_digitalasset_canton_protocol_v0_storage_proto_rawDescData)
	})
...
var file_com_digitalasset_canton_protocol_v0_storage_proto_goTypes = []interface{}{
...
func file_com_digitalasset_canton_protocol_v0_storage_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_digitalasset_canton_protocol_v0_storage_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*StoredParties); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_com_digitalasset_canton_protocol_v0_storage_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_com_digitalasset_canton_protocol_v0_storage_proto_rawDesc = nil
