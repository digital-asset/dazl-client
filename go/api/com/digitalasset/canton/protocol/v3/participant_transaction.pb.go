...
func file_com_digitalasset_canton_protocol_v3_participant_transaction_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_digitalasset_canton_protocol_v3_participant_transaction_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_com_digitalasset_canton_protocol_v3_participant_transaction_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_com_digitalasset_canton_protocol_v3_participant_transaction_proto_msgTypes[2].Exporter = func(v any, i int) any {
