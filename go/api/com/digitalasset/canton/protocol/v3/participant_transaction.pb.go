...
func file_com_digitalasset_canton_protocol_v3_participant_transaction_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_com_digitalasset_canton_protocol_v3_participant_transaction_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_digitalasset_canton_protocol_v3_participant_transaction_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	file_com_digitalasset_canton_protocol_v3_participant_transaction_proto_msgTypes[1].OneofWrappers = []interface{}{
		(*ActionDescription_Create)(nil),
		(*ActionDescription_Exercise)(nil),
		(*ActionDescription_Fetch)(nil),
		(*ActionDescription_LookupByKey)(nil),
	}
	file_com_digitalasset_canton_protocol_v3_participant_transaction_proto_msgTypes[2].OneofWrappers = []interface{}{}
	type x struct{}
