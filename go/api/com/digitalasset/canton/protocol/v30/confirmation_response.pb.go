...
const (
	...
	LocalVerdict_VERDICT_CODE_LOCAL_ABSTAIN   LocalVerdict_VerdictCode = 4
)
...
func (x *ConfirmationResponses) GetPhysicalSynchronizerId() string {
	if x != nil {
...
const file_com_digitalasset_canton_protocol_v30_confirmation_response_proto_rawDesc = "" +
	...
	"\x06reason\x18\x02 \x01(\v2\x12.google.rpc.StatusR\x06reason\"\xac\x01\n" +
	...
	"\rview_position\x18\x03 \x01(\v22.com.digitalasset.canton.protocol.v30.ViewPositionR\fviewPosition\"\xff\x01\n" +
	"\x15ConfirmationResponses\x12\x1d\n" +
	"\n" +
	"request_id\x18\x01 \x01(\x03R\trequestId\x12\x1b\n" +
	"\troot_hash\x18\x02 \x01(\fR\brootHash\x128\n" +
