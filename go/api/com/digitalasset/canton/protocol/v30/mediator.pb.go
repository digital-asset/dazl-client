...
func (x *RejectionReason) GetParticipantId() string {
	if x != nil {
...
func (x *ConfirmationResultMessage) GetPhysicalSynchronizerId() string {
	if x != nil {
...
const file_com_digitalasset_canton_protocol_v30_mediator_proto_rawDesc = "" +
	...
	"\areasons\x18\x01 \x03(\v25.com.digitalasset.canton.protocol.v30.RejectionReasonR\areasons\"\x9e\x01\n" +
	"\x0fRejectionReason\x12\x18\n" +
	"\aparties\x18\x01 \x03(\tR\aparties\x12J\n" +
	"\x06reject\x18\x02 \x01(\v22.com.digitalasset.canton.protocol.v30.LocalVerdictR\x06reject\x12%\n" +
	...
	"\fsome_verdict\"\xa7\x02\n" +
	"\x19ConfirmationResultMessage\x128\n" +
