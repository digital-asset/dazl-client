...
func (x *RootHashMessage) GetPhysicalSynchronizerId() string {
	if x != nil {
...
func (x *InputContract) GetContract() []byte {
	if x != nil {
		return x.Contract
	}
	return nil
...
func (x *CommonMetadata) GetPhysicalSynchronizerId() string {
	if x != nil {
		return x.PhysicalSynchronizerId
	}
	return ""
...
const file_com_digitalasset_canton_protocol_v30_participant_transaction_proto_rawDesc = "" +
	...
	"\troot_hash\x18\x01 \x01(\fR\brootHash\x128\n" +
	"\x18physical_synchronizer_id\x18\x02 \x01(\tR\x16physicalSynchronizerId\x12K\n" +
	...
	"\x04tree\x18\x01 \x01(\v28.com.digitalasset.canton.protocol.v30.GenTransactionTreeR\x04tree\"x\n" +
	...
	"rolledBack\"G\n" +
	"\rInputContract\x12\x1a\n" +
	"\bcontract\x18\x01 \x01(\fR\bcontract\x12\x1a\n" +
	"\bconsumed\x18\x02 \x01(\bR\bconsumed\"\xc9\x01\n" +
