...
const file_com_digitalasset_canton_time_v30_time_proof_proto_rawDesc = "" +
	"\n" +
	"1com/digitalasset/canton/time/v30/time_proof.proto\x12 com.digitalasset.canton.time.v30\x1a5com/digitalasset/canton/protocol/v30/sequencing.proto\"f\n" +
	"\tTimeProof\x12Y\n" +
	"\x05event\x18\x01 \x01(\v2C.com.digitalasset.canton.protocol.v30.PossiblyIgnoredSequencedEventR\x05eventBQZOgithub.com/digital-asset/dazl-client/v8/go/api/com/digitalasset/canton/time/v30b\x06proto3"

var (
	file_com_digitalasset_canton_time_v30_time_proof_proto_rawDescOnce sync.Once
	file_com_digitalasset_canton_time_v30_time_proof_proto_rawDescData []byte
)
...
func file_com_digitalasset_canton_time_v30_time_proof_proto_rawDescGZIP() []byte {
	file_com_digitalasset_canton_time_v30_time_proof_proto_rawDescOnce.Do(func() {
		file_com_digitalasset_canton_time_v30_time_proof_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_com_digitalasset_canton_time_v30_time_proof_proto_rawDesc), len(file_com_digitalasset_canton_time_v30_time_proof_proto_rawDesc)))
	})
...
func file_com_digitalasset_canton_time_v30_time_proof_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_com_digitalasset_canton_time_v30_time_proof_proto_rawDesc), len(file_com_digitalasset_canton_time_v30_time_proof_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
