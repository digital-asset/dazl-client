...
const file_com_digitalasset_canton_protocol_v1_synchronization_proto_rawDesc = "" +
	...
	" \x01(\v2H.com.digitalasset.canton.protocol.v1.RegisterTopologyTransactionResponseH\x00R#registerTopologyTransactionResponse\x12d\n" +
...
var (
	...
	file_com_digitalasset_canton_protocol_v1_synchronization_proto_rawDescData []byte
)
...
func file_com_digitalasset_canton_protocol_v1_synchronization_proto_rawDescGZIP() []byte {
	file_com_digitalasset_canton_protocol_v1_synchronization_proto_rawDescOnce.Do(func() {
		file_com_digitalasset_canton_protocol_v1_synchronization_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_com_digitalasset_canton_protocol_v1_synchronization_proto_rawDesc), len(file_com_digitalasset_canton_protocol_v1_synchronization_proto_rawDesc)))
	})
...
func file_com_digitalasset_canton_protocol_v1_synchronization_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_com_digitalasset_canton_protocol_v1_synchronization_proto_rawDesc), len(file_com_digitalasset_canton_protocol_v1_synchronization_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
