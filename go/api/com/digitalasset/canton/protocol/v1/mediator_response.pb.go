...
type MediatorResponse struct {
	...
	LocalVerdict      *LocalVerdict          `protobuf:"bytes,4,opt,name=local_verdict,json=localVerdict,proto3" json:"local_verdict,omitempty"`                // new type LocalVerdict
...
type LocalReject struct {
	...
	CausePrefix   string   `protobuf:"bytes,4,opt,name=cause_prefix,json=causePrefix,proto3" json:"cause_prefix,omitempty"`        // new field
	Details       string   `protobuf:"bytes,2,opt,name=details,proto3" json:"details,omitempty"`                                   // renamed from reason
	Resource      []string `protobuf:"bytes,3,rep,name=resource,proto3" json:"resource,omitempty"`                                 // affected resources
	ErrorCode     string   `protobuf:"bytes,5,opt,name=error_code,json=errorCode,proto3" json:"error_code,omitempty"`              // new field
	ErrorCategory uint32   `protobuf:"varint,6,opt,name=error_category,json=errorCategory,proto3" json:"error_category,omitempty"` // new field
}
