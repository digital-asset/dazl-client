...
func file_com_digitalasset_canton_protocol_v1_participant_transaction_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_com_digitalasset_canton_protocol_v1_participant_transaction_proto_msgTypes[15].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_digitalasset_canton_protocol_v1_participant_transaction_proto_msgTypes[16].Exporter = func(v interface{}, i int) interface{} {
	...
	file_com_digitalasset_canton_protocol_v1_participant_transaction_proto_msgTypes[13].OneofWrappers = []interface{}{
	...
	file_com_digitalasset_canton_protocol_v1_participant_transaction_proto_msgTypes[16].OneofWrappers = []interface{}{}
	type x struct{}
