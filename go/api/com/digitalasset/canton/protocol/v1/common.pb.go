...
type SerializableContract struct {
	...
	ContractSalt        *v01.Salt                         `protobuf:"bytes,5,opt,name=contract_salt,json=contractSalt,proto3" json:"contract_salt,omitempty"` // optional
}
...
var file_com_digitalasset_canton_protocol_v1_common_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_com_digitalasset_canton_protocol_v1_common_proto_goTypes = []interface{}{
	(*SerializableContract)(nil),             // 0: com.digitalasset.canton.protocol.v1.SerializableContract
	(*v0.SerializableContract_Metadata)(nil), // 1: com.digitalasset.canton.protocol.v0.SerializableContract.Metadata
	(*timestamppb.Timestamp)(nil),            // 2: google.protobuf.Timestamp
	(*v01.Salt)(nil),                         // 3: com.digitalasset.canton.crypto.v0.Salt
}
var file_com_digitalasset_canton_protocol_v1_common_proto_depIdxs = []int32{
	1, // 0: com.digitalasset.canton.protocol.v1.SerializableContract.metadata:type_name -> com.digitalasset.canton.protocol.v0.SerializableContract.Metadata
	2, // 1: com.digitalasset.canton.protocol.v1.SerializableContract.ledger_create_time:type_name -> google.protobuf.Timestamp
	3, // 2: com.digitalasset.canton.protocol.v1.SerializableContract.contract_salt:type_name -> com.digitalasset.canton.crypto.v0.Salt
...
func file_com_digitalasset_canton_protocol_v1_common_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_digitalasset_canton_protocol_v1_common_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
