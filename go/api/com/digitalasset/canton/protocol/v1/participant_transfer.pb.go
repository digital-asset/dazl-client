...
type TransferOutCommonData struct {
	...
	SourceProtocolVersion int32    `protobuf:"varint,7,opt,name=source_protocol_version,json=sourceProtocolVersion,proto3" json:"source_protocol_version,omitempty"` // added in v1
}
...
type TransferOutView struct {
	...
	TargetTimeProof       *v02.TimeProof `protobuf:"bytes,5,opt,name=target_time_proof,json=targetTimeProof,proto3" json:"target_time_proof,omitempty"`
	TargetProtocolVersion int32          `protobuf:"varint,6,opt,name=target_protocol_version,json=targetProtocolVersion,proto3" json:"target_protocol_version,omitempty"` // added in v1
}
...
type TransferInCommonData struct {
	...
	TargetProtocolVersion int32    `protobuf:"varint,7,opt,name=target_protocol_version,json=targetProtocolVersion,proto3" json:"target_protocol_version,omitempty"` // added in v1
}
...
type TransferInView struct {
	...
	SourceProtocolVersion  int32                 `protobuf:"varint,6,opt,name=source_protocol_version,json=sourceProtocolVersion,proto3" json:"source_protocol_version,omitempty"` // added in v1
}
...
var file_com_digitalasset_canton_protocol_v1_participant_transfer_proto_goTypes = []interface{}{
	...
	(*v02.TimeProof)(nil),              // 9: com.digitalasset.canton.time.v0.TimeProof
