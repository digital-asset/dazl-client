...
type TransactionResultMessage struct {
	...
	Verdict          *Verdict               `protobuf:"bytes,2,opt,name=verdict,proto3" json:"verdict,omitempty"` // new Verdict type
...
type MediatorReject struct {
	...
	Cause         string `protobuf:"bytes,2,opt,name=cause,proto3" json:"cause,omitempty"` // renamed reason -> cause
...
type MalformedMediatorRequestResult struct {
	...
	Rejection *MediatorReject        `protobuf:"bytes,4,opt,name=rejection,proto3" json:"rejection,omitempty"` // MediatorRejection -> MediatorReject
}
...
type TransferResult struct {
	...
	Verdict   *Verdict                `protobuf:"bytes,5,opt,name=verdict,proto3" json:"verdict,omitempty"` // new Verdict type
}
