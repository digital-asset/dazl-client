...
const file_com_digitalasset_canton_protocol_v31_common_stable_proto_rawDesc = "" +
	...
	"\fpackage_name\x18\x03 \x01(\tR\vpackageName\x12\x12\n" +
	"\x04hash\x18\x04 \x01(\fR\x04hashBUZSgithub.com/digital-asset/dazl-client/v8/go/api/com/digitalasset/canton/protocol/v31b\x06proto3"

var (
	file_com_digitalasset_canton_protocol_v31_common_stable_proto_rawDescOnce sync.Once
	file_com_digitalasset_canton_protocol_v31_common_stable_proto_rawDescData []byte
)

func file_com_digitalasset_canton_protocol_v31_common_stable_proto_rawDescGZIP() []byte {
	file_com_digitalasset_canton_protocol_v31_common_stable_proto_rawDescOnce.Do(func() {
		file_com_digitalasset_canton_protocol_v31_common_stable_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_com_digitalasset_canton_protocol_v31_common_stable_proto_rawDesc), len(file_com_digitalasset_canton_protocol_v31_common_stable_proto_rawDesc)))
	})
...
func file_com_digitalasset_canton_protocol_v31_common_stable_proto_init() {
	if File_com_digitalasset_canton_protocol_v31_common_stable_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_com_digitalasset_canton_protocol_v31_common_stable_proto_goTypes,
		DependencyIndexes: file_com_digitalasset_canton_protocol_v31_common_stable_proto_depIdxs,
		MessageInfos:      file_com_digitalasset_canton_protocol_v31_common_stable_proto_msgTypes,
	}.Build()
	File_com_digitalasset_canton_protocol_v31_common_stable_proto = out.File
	file_com_digitalasset_canton_protocol_v31_common_stable_proto_goTypes = nil
	file_com_digitalasset_canton_protocol_v31_common_stable_proto_depIdxs = nil
}
