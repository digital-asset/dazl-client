...
func file_com_digitalasset_canton_domain_admin_v0_domain_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_digitalasset_canton_domain_admin_v0_domain_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_com_digitalasset_canton_domain_admin_v0_domain_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_com_digitalasset_canton_domain_admin_v0_domain_service_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_com_digitalasset_canton_domain_admin_v0_domain_service_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_com_digitalasset_canton_domain_admin_v0_domain_service_proto_msgTypes[4].Exporter = func(v any, i int) any {
