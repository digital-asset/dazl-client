...
var file_com_digitalasset_canton_domain_admin_v0_domain_initialization_service_proto_goTypes = []interface{}{
...
func file_com_digitalasset_canton_domain_admin_v0_domain_initialization_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_digitalasset_canton_domain_admin_v0_domain_initialization_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DomainNodeSequencerConfig); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_com_digitalasset_canton_domain_admin_v0_domain_initialization_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DomainInitRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
