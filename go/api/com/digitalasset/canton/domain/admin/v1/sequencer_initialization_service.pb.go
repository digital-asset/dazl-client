...
const file_com_digitalasset_canton_domain_admin_v1_sequencer_initialization_service_proto_rawDesc = "" +
	"\n" +
	"Ncom/digitalasset/canton/domain/admin/v1/sequencer_initialization_service.proto\x12'com.digitalasset.canton.domain.admin.v1\x1aOcom/digitalasset/canton/domain/admin/v0/sequencer_initialization_snapshot.proto\x1a4com/digitalasset/canton/protocol/v1/sequencing.proto\x1a6com/digitalasset/canton/protocol/v0/topology_ext.proto\"\xd4\x02\n" +
	...
	"\x11domain_parameters\x18\x04 \x01(\v2;.com.digitalasset.canton.protocol.v1.StaticDomainParametersR\x10domainParameters\x12V\n" +
	"\bsnapshot\x18\x03 \x01(\v2:.com.digitalasset.canton.domain.admin.v0.SequencerSnapshotR\bsnapshotBXZVgithub.com/digital-asset/dazl-client/v8/go/api/com/digitalasset/canton/domain/admin/v1b\x06proto3"

var (
	file_com_digitalasset_canton_domain_admin_v1_sequencer_initialization_service_proto_rawDescOnce sync.Once
	file_com_digitalasset_canton_domain_admin_v1_sequencer_initialization_service_proto_rawDescData []byte
)
...
func file_com_digitalasset_canton_domain_admin_v1_sequencer_initialization_service_proto_rawDescGZIP() []byte {
	file_com_digitalasset_canton_domain_admin_v1_sequencer_initialization_service_proto_rawDescOnce.Do(func() {
		file_com_digitalasset_canton_domain_admin_v1_sequencer_initialization_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_com_digitalasset_canton_domain_admin_v1_sequencer_initialization_service_proto_rawDesc), len(file_com_digitalasset_canton_domain_admin_v1_sequencer_initialization_service_proto_rawDesc)))
	})
...
func file_com_digitalasset_canton_domain_admin_v1_sequencer_initialization_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_com_digitalasset_canton_domain_admin_v1_sequencer_initialization_service_proto_rawDesc), len(file_com_digitalasset_canton_domain_admin_v1_sequencer_initialization_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
