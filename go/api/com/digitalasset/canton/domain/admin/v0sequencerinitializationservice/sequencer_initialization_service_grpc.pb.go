...
type SequencerInitializationServiceClient interface {
	...
	InitV2(ctx context.Context, in *v2.InitRequest, opts ...grpc.CallOption) (*InitResponse, error)
}
...
func (c *sequencerInitializationServiceClient) InitV2(ctx context.Context, in *v2.InitRequest, opts ...grpc.CallOption) (*InitResponse, error) {
	out := new(InitResponse)
	err := c.cc.Invoke(ctx, "/com.digitalasset.canton.domain.admin.v0.SequencerInitializationService/InitV2", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SequencerInitializationServiceServer interface {
	...
	InitV2(context.Context, *v2.InitRequest) (*InitResponse, error)
...
func (UnimplementedSequencerInitializationServiceServer) InitV2(context.Context, *v2.InitRequest) (*InitResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method InitV2 not implemented")
}
...
func _SequencerInitializationService_InitV2_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(v2.InitRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SequencerInitializationServiceServer).InitV2(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.digitalasset.canton.domain.admin.v0.SequencerInitializationService/InitV2",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SequencerInitializationServiceServer).InitV2(ctx, req.(*v2.InitRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SequencerInitializationService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "InitV2",
			Handler:    _SequencerInitializationService_InitV2_Handler,
		},
	},
