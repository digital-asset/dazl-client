...
type InitRequest struct {
	...
	Snapshot         *SequencerSnapshot         `protobuf:"bytes,3,opt,name=snapshot,proto3" json:"snapshot,omitempty"`
...
func (x *InitRequest) GetSnapshot() *SequencerSnapshot {
	if x != nil {
		return x.Snapshot
	}
	return nil
...
var file_com_digitalasset_canton_domain_admin_v0_sequencer_initialization_service_proto_goTypes = []any{
	...
	(*SequencerSnapshot)(nil),         // 5: com.digitalasset.canton.domain.admin.v0.SequencerSnapshot
