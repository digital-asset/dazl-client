...
var file_com_digitalasset_canton_domain_api_v0_sequencer_connection_proto_goTypes = []interface{}{
...
func file_com_digitalasset_canton_domain_api_v0_sequencer_connection_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_digitalasset_canton_domain_api_v0_sequencer_connection_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SequencerConnection); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_com_digitalasset_canton_domain_api_v0_sequencer_connection_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SequencerConnection_Grpc); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_com_digitalasset_canton_domain_api_v0_sequencer_connection_proto_msgTypes[0].OneofWrappers = []interface{}{
