...
var file_com_digitalasset_canton_domain_api_v0_domain_time_service_proto_goTypes = []interface{}{
...
func file_com_digitalasset_canton_domain_api_v0_domain_time_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_digitalasset_canton_domain_api_v0_domain_time_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_digitalasset_canton_domain_api_v0_domain_time_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_digitalasset_canton_domain_api_v0_domain_time_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
