...
func file_com_digitalasset_canton_domain_api_v0_service_agreement_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_digitalasset_canton_domain_api_v0_service_agreement_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_com_digitalasset_canton_domain_api_v0_service_agreement_proto_msgTypes[1].Exporter = func(v any, i int) any {
