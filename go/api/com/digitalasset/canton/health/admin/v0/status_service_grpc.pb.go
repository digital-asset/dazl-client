...
type StatusServiceClient interface {
	...
	HealthDump(ctx context.Context, in *HealthDumpRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[HealthDumpChunk], error)
...
func (c *statusServiceClient) HealthDump(ctx context.Context, in *HealthDumpRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[HealthDumpChunk], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &StatusService_ServiceDesc.Streams[0], StatusService_HealthDump_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[HealthDumpRequest, HealthDumpChunk]{ClientStream: stream}
...
type StatusService_HealthDumpClient = grpc.ServerStreamingClient[HealthDumpChunk]
...
type StatusServiceServer interface {
	...
	HealthDump(*HealthDumpRequest, grpc.ServerStreamingServer[HealthDumpChunk]) error
...
func (UnimplementedStatusServiceServer) HealthDump(*HealthDumpRequest, grpc.ServerStreamingServer[HealthDumpChunk]) error {
...
func _StatusService_HealthDump_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(StatusServiceServer).HealthDump(m, &grpc.GenericServerStream[HealthDumpRequest, HealthDumpChunk]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type StatusService_HealthDumpServer = grpc.ServerStreamingServer[HealthDumpChunk]
