...
const (
	...
	TopologyManagerWriteService_AuthorizeCheckOnlyPackages_FullMethodName      = "/com.digitalasset.canton.topology.admin.v0.TopologyManagerWriteService/AuthorizeCheckOnlyPackages"
...
type TopologyManagerWriteServiceClient interface {
	...
	AuthorizeCheckOnlyPackages(ctx context.Context, in *CheckOnlyPackagesAuthorization, opts ...grpc.CallOption) (*AuthorizationSuccess, error)
...
func (c *topologyManagerWriteServiceClient) AuthorizeCheckOnlyPackages(ctx context.Context, in *CheckOnlyPackagesAuthorization, opts ...grpc.CallOption) (*AuthorizationSuccess, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AuthorizationSuccess)
	err := c.cc.Invoke(ctx, TopologyManagerWriteService_AuthorizeCheckOnlyPackages_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TopologyManagerWriteServiceServer interface {
	...
	AuthorizeCheckOnlyPackages(context.Context, *CheckOnlyPackagesAuthorization) (*AuthorizationSuccess, error)
...
func (UnimplementedTopologyManagerWriteServiceServer) AuthorizeCheckOnlyPackages(context.Context, *CheckOnlyPackagesAuthorization) (*AuthorizationSuccess, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AuthorizeCheckOnlyPackages not implemented")
}
...
func _TopologyManagerWriteService_AuthorizeCheckOnlyPackages_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CheckOnlyPackagesAuthorization)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TopologyManagerWriteServiceServer).AuthorizeCheckOnlyPackages(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TopologyManagerWriteService_AuthorizeCheckOnlyPackages_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TopologyManagerWriteServiceServer).AuthorizeCheckOnlyPackages(ctx, req.(*CheckOnlyPackagesAuthorization))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TopologyManagerWriteService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AuthorizeCheckOnlyPackages",
			Handler:    _TopologyManagerWriteService_AuthorizeCheckOnlyPackages_Handler,
		},
		{
