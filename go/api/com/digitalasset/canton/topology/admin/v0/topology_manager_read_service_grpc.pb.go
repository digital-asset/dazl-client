...
const (
	...
	TopologyManagerReadService_ListCheckOnlyPackages_FullMethodName        = "/com.digitalasset.canton.topology.admin.v0.TopologyManagerReadService/ListCheckOnlyPackages"
...
type TopologyManagerReadServiceClient interface {
	...
	ListCheckOnlyPackages(ctx context.Context, in *ListCheckOnlyPackagesRequest, opts ...grpc.CallOption) (*ListCheckOnlyPackagesResult, error)
...
func (c *topologyManagerReadServiceClient) ListCheckOnlyPackages(ctx context.Context, in *ListCheckOnlyPackagesRequest, opts ...grpc.CallOption) (*ListCheckOnlyPackagesResult, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListCheckOnlyPackagesResult)
	err := c.cc.Invoke(ctx, TopologyManagerReadService_ListCheckOnlyPackages_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TopologyManagerReadServiceServer interface {
	...
	ListCheckOnlyPackages(context.Context, *ListCheckOnlyPackagesRequest) (*ListCheckOnlyPackagesResult, error)
...
func (UnimplementedTopologyManagerReadServiceServer) ListCheckOnlyPackages(context.Context, *ListCheckOnlyPackagesRequest) (*ListCheckOnlyPackagesResult, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListCheckOnlyPackages not implemented")
}
...
func _TopologyManagerReadService_ListCheckOnlyPackages_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListCheckOnlyPackagesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TopologyManagerReadServiceServer).ListCheckOnlyPackages(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TopologyManagerReadService_ListCheckOnlyPackages_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TopologyManagerReadServiceServer).ListCheckOnlyPackages(ctx, req.(*ListCheckOnlyPackagesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TopologyManagerReadService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ListCheckOnlyPackages",
			Handler:    _TopologyManagerReadService_ListCheckOnlyPackages_Handler,
		},
		{
