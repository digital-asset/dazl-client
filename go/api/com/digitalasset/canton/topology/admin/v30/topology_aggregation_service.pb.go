...
func (x *ListPartiesResponse_Result_ParticipantSynchronizers_SynchronizerPermissions) GetPhysicalSynchronizerId() string {
	if x != nil {
...
func (x *ListKeyOwnersResponse_Result) GetPhysicalSynchronizerId() string {
	if x != nil {
		return x.PhysicalSynchronizerId
	}
	return ""
...
const file_com_digitalasset_canton_topology_admin_v30_topology_aggregation_service_proto_rawDesc = "" +
	...
	"\x12filter_participant\x18\x05 \x01(\tR\x11filterParticipant\"\xe6\x05\n" +
	"\x13ListPartiesResponse\x12`\n" +
	"\aresults\x18\x02 \x03(\v2F.com.digitalasset.canton.topology.admin.v30.ListPartiesResponse.ResultR\aresults\x1a\xec\x04\n" +
	"\x06Result\x12\x14\n" +
	"\x05party\x18\x01 \x01(\tR\x05party\x12\x83\x01\n" +
	"\fparticipants\x18\x02 \x03(\v2_.com.digitalasset.canton.topology.admin.v30.ListPartiesResponse.Result.ParticipantSynchronizersR\fparticipants\x1a\xc5\x03\n" +
	"\x18ParticipantSynchronizers\x12'\n" +
	"\x0fparticipant_uid\x18\x01 \x01(\tR\x0eparticipantUid\x12\x9d\x01\n" +
	"\rsynchronizers\x18\x02 \x03(\v2w.com.digitalasset.canton.topology.admin.v30.ListPartiesResponse.Result.ParticipantSynchronizers.SynchronizerPermissionsR\rsynchronizers\x1a\xdf\x01\n" +
