...
type SetTimeModelRequest struct {
	...
	MaximumRecordTime *timestamp.Timestamp `protobuf:"bytes,2,opt,name=maximum_record_time,json=maximumRecordTime,proto3" json:"maximum_record_time,omitempty"`
...
func (x *SetTimeModelRequest) GetMaximumRecordTime() *timestamp.Timestamp {
	if x != nil {
...
type TimeModel struct {
	...
	// Required.
	AvgTransactionLatency *duration.Duration `protobuf:"bytes,4,opt,name=avg_transaction_latency,json=avgTransactionLatency,proto3" json:"avg_transaction_latency,omitempty"`
	// The minimimum skew between ledger time and record time: lt_TX >= rt_TX - minSkew
	// Required.
	MinSkew *duration.Duration `protobuf:"bytes,5,opt,name=min_skew,json=minSkew,proto3" json:"min_skew,omitempty"`
	// The maximum skew between ledger time and record time: lt_TX <= rt_TX + maxSkew
	// Required.
	MaxSkew *duration.Duration `protobuf:"bytes,6,opt,name=max_skew,json=maxSkew,proto3" json:"max_skew,omitempty"`
}
...
func (x *TimeModel) GetAvgTransactionLatency() *duration.Duration {
	if x != nil {
...
func (x *TimeModel) GetMinSkew() *duration.Duration {
	if x != nil {
		return x.MinSkew
	}
	return nil
...
func (x *TimeModel) GetMaxSkew() *duration.Duration {
	if x != nil {
		return x.MaxSkew
	}
	return nil
...
var file_com_daml_ledger_api_v1_admin_config_management_service_proto_rawDesc = []byte{
	...
	0x7e, 0x0a, 0x1c, 0x63, 0x6f, 0x6d, 0x2e, 0x64, 0x61, 0x6d, 0x6c, 0x2e, 0x6c, 0x65, 0x64, 0x67,
	0x65, 0x72, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x31, 0x2e, 0x61, 0x64, 0x6d, 0x69, 0x6e, 0x42,
	0x21, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x4d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x6d, 0x65, 0x6e,
...
// UnimplementedConfigManagementServiceServer can be embedded to have forward compatible implementations.
...
func RegisterConfigManagementServiceServer(s *grpc.Server, srv ConfigManagementServiceServer) {
	s.RegisterService(&_ConfigManagementService_serviceDesc, srv)
}
...
var _ConfigManagementService_serviceDesc = grpc.ServiceDesc{
