...
from dazl.model.types import SCALAR_TYPE_INTEGER, NamedArgumentList, RecordType, TypeReference
...
def test_validations():
    ...
    data_type = RecordType(
        name=type_ref, named_args=NamedArgumentList((("a", SCALAR_TYPE_INTEGER),)), type_args=()
    )
