...
from ...models.get_participant_id_response import GetParticipantIdResponse
...
) -> GetParticipantIdResponse | JsCantonError | str:
    if response.status_code == 200:
        response_200 = GetParticipantIdResponse.from_dict(response.json())
