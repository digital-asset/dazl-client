...
from ...models.get_ledger_end_response import GetLedgerEndResponse
...
) -> GetLedgerEndResponse | JsCantonError | str:
    if response.status_code == 200:
        response_200 = GetLedgerEndResponse.from_dict(response.json())
