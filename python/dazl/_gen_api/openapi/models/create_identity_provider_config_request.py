...
T = TypeVar("T", bound="CreateIdentityProviderConfigRequest")


@_attrs_define
class CreateIdentityProviderConfigRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_identity_provider_config_request = cls(
            identity_provider_config=identity_provider_config,
        )

        create_identity_provider_config_request.additional_properties = d
        return create_identity_provider_config_request
