...
T = TypeVar("T", bound="JsAssignmentEvent")


@_attrs_define
class JsAssignmentEvent:
    """
    Attributes:
        source (str):
        target (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        js_assignment_event.additional_properties = d
        return js_assignment_event
