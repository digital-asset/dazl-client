...
T = TypeVar("T", bound="UpdateIdentityProviderConfigResponse")
...
class UpdateIdentityProviderConfigResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_identity_provider_config_response.additional_properties = d
        return update_identity_provider_config_response
