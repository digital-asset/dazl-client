...
T = TypeVar("T", bound="JsGetTransactionResponse")


@_attrs_define
class JsGetTransactionResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        js_get_transaction_response = cls(
            transaction=transaction,
        )

        js_get_transaction_response.additional_properties = d
        return js_get_transaction_response
