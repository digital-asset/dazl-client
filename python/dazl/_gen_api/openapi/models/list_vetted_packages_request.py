...
class ListVettedPackagesRequest:
    ...
    Attributes:
        ...
        topology_state_filter (TopologyStateFilter | Unset): Filter the vetted packages by the participant and
            ...
            field.
        page_token (str | Unset): Pagination token to determine the specific page to fetch. Using the token
            ...
            Optional
        page_size (int | Unset): Maximum number of ``VettedPackages`` results to return in a single page.
