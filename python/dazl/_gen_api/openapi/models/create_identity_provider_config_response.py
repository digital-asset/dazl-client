...
T = TypeVar("T", bound="CreateIdentityProviderConfigResponse")


@_attrs_define
class CreateIdentityProviderConfigResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_identity_provider_config_response = cls(
            identity_provider_config=identity_provider_config,
        )

        create_identity_provider_config_response.additional_properties = d
        return create_identity_provider_config_response
