...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in com/digitalasset/canton/crypto/admin/v0/vault_service_pb2_grpc.py depends on'
...
def add_VaultServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('com.digitalasset.canton.crypto.admin.v0.VaultService', rpc_method_handlers)
