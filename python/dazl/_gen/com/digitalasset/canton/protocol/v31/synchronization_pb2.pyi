...
class EnvelopeContent(_message.Message):
    __slots__ = ("informee_message", "encrypted_multiple_views_message", "unassignment_mediator_message", "assignment_mediator_message", "root_hash_message", "topology_transactions_broadcast", "acs_commitment_protocol_message", "lsu_sequencing_test_message")
    INFORMEE_MESSAGE_FIELD_NUMBER: _ClassVar[int]
    ENCRYPTED_MULTIPLE_VIEWS_MESSAGE_FIELD_NUMBER: _ClassVar[int]
    ...
    encrypted_multiple_views_message: _participant_transaction_pb2_1.EncryptedMultipleViewsMessage
