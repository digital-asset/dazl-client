...
class ParticipantMetadata(_message.Message):
    ...
    submission_time: int
    workflow_id: str
    def __init__(self, salt: _Optional[_Union[_crypto_pb2.Salt, _Mapping]] = ..., ledger_time: _Optional[int] = ..., submission_time: _Optional[int] = ..., workflow_id: _Optional[str] = ...) -> None: ...

class RootHashMessage(_message.Message):
    __slots__ = ("root_hash", "domain_id", "view_type", "submission_topology_time", "payload")
    ...
    payload: bytes
    def __init__(self, root_hash: _Optional[bytes] = ..., domain_id: _Optional[str] = ..., view_type: _Optional[_Union[_common_pb2.ViewType, str]] = ..., submission_topology_time: _Optional[int] = ..., payload: _Optional[bytes] = ...) -> None: ...
...
class CommonMetadata(_message.Message):
    __slots__ = ("salt", "domain_id", "uuid", "mediator_group")
    SALT_FIELD_NUMBER: _ClassVar[int]
    DOMAIN_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    uuid: str
    mediator_group: int
    def __init__(self, salt: _Optional[_Union[_crypto_pb2.Salt, _Mapping]] = ..., domain_id: _Optional[str] = ..., uuid: _Optional[str] = ..., mediator_group: _Optional[int] = ...) -> None: ...

class SubmitterMetadata(_message.Message):
    __slots__ = ("salt", "act_as", "application_id", "command_id", "submitting_participant_uid", "submission_id", "dedup_period", "max_sequencing_time")
    SALT_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, salt: _Optional[_Union[_crypto_pb2.Salt, _Mapping]] = ..., act_as: _Optional[_Iterable[str]] = ..., application_id: _Optional[str] = ..., command_id: _Optional[str] = ..., submitting_participant_uid: _Optional[str] = ..., submission_id: _Optional[str] = ..., dedup_period: _Optional[_Union[DeduplicationPeriod, _Mapping]] = ..., max_sequencing_time: _Optional[int] = ...) -> None: ...

class SessionKeyLookup(_message.Message):
    __slots__ = ("session_key_randomness", "encryption_algorithm_spec", "fingerprint")
    ...
    encryption_algorithm_spec: _crypto_pb2.EncryptionAlgorithmSpec
    fingerprint: str
    def __init__(self, session_key_randomness: _Optional[bytes] = ..., encryption_algorithm_spec: _Optional[_Union[_crypto_pb2.EncryptionAlgorithmSpec, str]] = ..., fingerprint: _Optional[str] = ...) -> None: ...

class EncryptedViewMessage(_message.Message):
    __slots__ = ("view_tree", "encryption_scheme", "submitting_participant_signature", "view_hash", "randomness", "session_key_randomness", "domain_id", "view_type")
...
class ActionDescription(_message.Message):
    ...
    class ExerciseActionDescription(_message.Message):
        ...
        node_seed: bytes
        failed: bool
        interface_id: _wrappers_pb2.StringValue
        template_id: str
        package_preference: _containers.RepeatedScalarFieldContainer[str]
        def __init__(self, input_contract_id: _Optional[str] = ..., choice: _Optional[str] = ..., chosen_value: _Optional[bytes] = ..., actors: _Optional[_Iterable[str]] = ..., by_key: bool = ..., node_seed: _Optional[bytes] = ..., failed: bool = ..., interface_id: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ..., template_id: _Optional[str] = ..., package_preference: _Optional[_Iterable[str]] = ...) -> None: ...
    class FetchActionDescription(_message.Message):
        __slots__ = ("input_contract_id", "actors", "by_key", "template_id")
        INPUT_CONTRACT_ID_FIELD_NUMBER: _ClassVar[int]
        ACTORS_FIELD_NUMBER: _ClassVar[int]
        BY_KEY_FIELD_NUMBER: _ClassVar[int]
        TEMPLATE_ID_FIELD_NUMBER: _ClassVar[int]
        ...
        by_key: bool
        template_id: str
        def __init__(self, input_contract_id: _Optional[str] = ..., actors: _Optional[_Iterable[str]] = ..., by_key: bool = ..., template_id: _Optional[str] = ...) -> None: ...
