...
from .status_service_pb2 import GetLastErrorTraceRequest, GetLastErrorTraceResponse, GetLastErrorsRequest, GetLastErrorsResponse, HealthDumpRequest, HealthDumpResponse, SetLogLevelRequest, SetLogLevelResponse, StatusRequest, StatusResponse
...
class StatusServiceStub:
    ...
    def Status(self, __1: StatusRequest, *, timeout: _typing.Optional[float] = ..., metadata: _typing.Optional[_typing.Tuple[_typing.Tuple[str, _typing.Union[str, bytes]], ...]] = ..., credentials: _typing.Optional[_grpc.CallCredentials] = ..., wait_for_ready: _typing.Optional[bool] = ..., compression: _typing.Optional[_grpc.Compression] = ...) -> _typing.Union[StatusResponse, _grpc_aio.UnaryUnaryCall[_typing.Any, StatusResponse]]: ...
...
class _StatusServiceBlockingStub(StatusServiceStub):
    def Status(self, __1: StatusRequest, timeout: _typing.Optional[float] = ..., metadata: _typing.Optional[_typing.Tuple[_typing.Tuple[str, _typing.Union[str, bytes]], ...]] = ..., credentials: _typing.Optional[_grpc.CallCredentials] = ..., wait_for_ready: _typing.Optional[bool] = ..., compression: _typing.Optional[_grpc.Compression] = ...) -> StatusResponse: ...
...
class _StatusServiceAsyncStub(StatusServiceStub):
    def Status(self, __1: StatusRequest, *, timeout: _typing.Optional[float] = ..., metadata: _typing.Optional[_grpc_aio.Metadata] = ..., credentials: _typing.Optional[_grpc.CallCredentials] = ..., wait_for_ready: _typing.Optional[bool] = ..., compression: _typing.Optional[_grpc.Compression] = ...) -> _grpc_aio.UnaryUnaryCall[_typing.Any, StatusResponse]: ...  # type: ignore
