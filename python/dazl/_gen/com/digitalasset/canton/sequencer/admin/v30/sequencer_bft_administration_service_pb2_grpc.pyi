...
class SequencerBftAdministrationServiceStub:
    ...
    def AddPeerEndpoint(self, __1: AddPeerEndpointRequest, *, timeout: _typing.Optional[float] = ..., metadata: _typing.Optional[_typing.Tuple[_typing.Tuple[str, str | bytes], ...]] = ..., credentials: _typing.Optional[_grpc.CallCredentials] = ..., wait_for_ready: _typing.Optional[bool] = ..., compression: _typing.Optional[_grpc.Compression] = ...) -> AddPeerEndpointResponse | _grpc_aio.UnaryUnaryCall[_typing.Any, AddPeerEndpointResponse]: ...
    def RemovePeerEndpoint(self, __1: RemovePeerEndpointRequest, *, timeout: _typing.Optional[float] = ..., metadata: _typing.Optional[_typing.Tuple[_typing.Tuple[str, str | bytes], ...]] = ..., credentials: _typing.Optional[_grpc.CallCredentials] = ..., wait_for_ready: _typing.Optional[bool] = ..., compression: _typing.Optional[_grpc.Compression] = ...) -> RemovePeerEndpointResponse | _grpc_aio.UnaryUnaryCall[_typing.Any, RemovePeerEndpointResponse]: ...
    def GetPeerNetworkStatus(self, __1: GetPeerNetworkStatusRequest, *, timeout: _typing.Optional[float] = ..., metadata: _typing.Optional[_typing.Tuple[_typing.Tuple[str, str | bytes], ...]] = ..., credentials: _typing.Optional[_grpc.CallCredentials] = ..., wait_for_ready: _typing.Optional[bool] = ..., compression: _typing.Optional[_grpc.Compression] = ...) -> GetPeerNetworkStatusResponse | _grpc_aio.UnaryUnaryCall[_typing.Any, GetPeerNetworkStatusResponse]: ...
    def GetWriteReadiness(self, __1: GetWriteReadinessRequest, *, timeout: _typing.Optional[float] = ..., metadata: _typing.Optional[_typing.Tuple[_typing.Tuple[str, str | bytes], ...]] = ..., credentials: _typing.Optional[_grpc.CallCredentials] = ..., wait_for_ready: _typing.Optional[bool] = ..., compression: _typing.Optional[_grpc.Compression] = ...) -> GetWriteReadinessResponse | _grpc_aio.UnaryUnaryCall[_typing.Any, GetWriteReadinessResponse]: ...
    def GetOrderingTopology(self, __1: GetOrderingTopologyRequest, *, timeout: _typing.Optional[float] = ..., metadata: _typing.Optional[_typing.Tuple[_typing.Tuple[str, str | bytes], ...]] = ..., credentials: _typing.Optional[_grpc.CallCredentials] = ..., wait_for_ready: _typing.Optional[bool] = ..., compression: _typing.Optional[_grpc.Compression] = ...) -> GetOrderingTopologyResponse | _grpc_aio.UnaryUnaryCall[_typing.Any, GetOrderingTopologyResponse]: ...
    def SetPerformanceMetricsEnabled(self, __1: SetPerformanceMetricsEnabledRequest, *, timeout: _typing.Optional[float] = ..., metadata: _typing.Optional[_typing.Tuple[_typing.Tuple[str, str | bytes], ...]] = ..., credentials: _typing.Optional[_grpc.CallCredentials] = ..., wait_for_ready: _typing.Optional[bool] = ..., compression: _typing.Optional[_grpc.Compression] = ...) -> SetPerformanceMetricsEnabledResponse | _grpc_aio.UnaryUnaryCall[_typing.Any, SetPerformanceMetricsEnabledResponse]: ...
...
class _SequencerBftAdministrationServiceAsyncStub(SequencerBftAdministrationServiceStub):
    ...
    def GetWriteReadiness(self, __1: GetWriteReadinessRequest, *, timeout: _typing.Optional[float] = ..., metadata: _typing.Optional[_grpc_aio.Metadata] = ..., credentials: _typing.Optional[_grpc.CallCredentials] = ..., wait_for_ready: _typing.Optional[bool] = ..., compression: _typing.Optional[_grpc.Compression] = ...) -> _grpc_aio.UnaryUnaryCall[_typing.Any, GetWriteReadinessResponse]: ...  # type: ignore
    ...
    def SetPerformanceMetricsEnabled(self, __1: SetPerformanceMetricsEnabledRequest, *, timeout: _typing.Optional[float] = ..., metadata: _typing.Optional[_grpc_aio.Metadata] = ..., credentials: _typing.Optional[_grpc.CallCredentials] = ..., wait_for_ready: _typing.Optional[bool] = ..., compression: _typing.Optional[_grpc.Compression] = ...) -> _grpc_aio.UnaryUnaryCall[_typing.Any, SetPerformanceMetricsEnabledResponse]: ...  # type: ignore
