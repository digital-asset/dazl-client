...
class SequencerInitializationServiceStub:
    ...
    def InitializeSequencerFromLsuPredecessor(self, __1: _typing.Iterable[InitializeSequencerFromLsuPredecessorRequest], *, timeout: _typing.Optional[float] = ..., metadata: _typing.Optional[_typing.Tuple[_typing.Tuple[str, str | bytes], ...]] = ..., credentials: _typing.Optional[_grpc.CallCredentials] = ..., wait_for_ready: _typing.Optional[bool] = ..., compression: _typing.Optional[_grpc.Compression] = ...) -> InitializeSequencerFromLsuPredecessorResponse | _grpc_aio.UnaryUnaryCall[_typing.Any, InitializeSequencerFromLsuPredecessorResponse]: ...
...
class _SequencerInitializationServiceAsyncStub(SequencerInitializationServiceStub):
    ...
    def InitializeSequencerFromLsuPredecessor(self, __1: _typing.Iterable[InitializeSequencerFromLsuPredecessorRequest], *, timeout: _typing.Optional[float] = ..., metadata: _typing.Optional[_grpc_aio.Metadata] = ..., credentials: _typing.Optional[_grpc.CallCredentials] = ..., wait_for_ready: _typing.Optional[bool] = ..., compression: _typing.Optional[_grpc.Compression] = ...) -> _grpc_aio.UnaryUnaryCall[_typing.Any, InitializeSequencerFromLsuPredecessorResponse]: ...  # type: ignore
