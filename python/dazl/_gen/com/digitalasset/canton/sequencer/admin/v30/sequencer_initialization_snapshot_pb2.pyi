...
class SequencerSnapshot(_message.Message):
    __slots__ = ("latest_timestamp", "last_block_height", "head_member_counters", "status", "additional", "in_flight_aggregations", "traffic_purchased", "traffic_consumed")
    ...
    def __init__(self, latest_timestamp: _Optional[int] = ..., last_block_height: _Optional[int] = ..., head_member_counters: _Optional[_Iterable[_Union[SequencerSnapshot.MemberCounter, _Mapping]]] = ..., status: _Optional[_Union[SequencerPruningStatus, _Mapping]] = ..., additional: _Optional[_Union[ImplementationSpecificInfo, _Mapping]] = ..., in_flight_aggregations: _Optional[_Iterable[_Union[SequencerSnapshot.InFlightAggregationWithId, _Mapping]]] = ..., traffic_purchased: _Optional[_Iterable[_Union[_traffic_control_parameters_pb2.TrafficPurchased, _Mapping]]] = ..., traffic_consumed: _Optional[_Iterable[_Union[_traffic_control_parameters_pb2.TrafficConsumed, _Mapping]]] = ...) -> None: ...
...
class SequencerMemberStatus(_message.Message):
    ...
    member: str
    registered_at: int
    last_acknowledged: _wrappers_pb2.Int64Value
    enabled: bool
    def __init__(self, member: _Optional[str] = ..., registered_at: _Optional[int] = ..., last_acknowledged: _Optional[_Union[_wrappers_pb2.Int64Value, _Mapping]] = ..., enabled: bool = ...) -> None: ...
