...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_DOMAINTIMETRACKERCONFIG']._serialized_start=387
  _globals['_DOMAINTIMETRACKERCONFIG']._serialized_end=755
