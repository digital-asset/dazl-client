...
class SynchronizerTimeTrackerConfig(_message.Message):
    ...
    def __init__(self, observation_latency: _Optional[_Union[datetime.timedelta, _duration_pb2.Duration, _Mapping]] = ..., patience_duration: _Optional[_Union[datetime.timedelta, _duration_pb2.Duration, _Mapping]] = ..., min_observation_duration: _Optional[_Union[datetime.timedelta, _duration_pb2.Duration, _Mapping]] = ..., time_proof_request: _Optional[_Union[TimeProofRequestConfig, _Mapping]] = ...) -> None: ...
