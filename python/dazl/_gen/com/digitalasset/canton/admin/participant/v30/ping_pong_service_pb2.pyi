...
class PingRequest(_message.Message):
    __slots__ = ("target_parties", "validators", "timeout", "levels", "domain_id", "workflow_id", "id")
    ...
    workflow_id: str
    id: str
    def __init__(self, target_parties: _Optional[_Iterable[str]] = ..., validators: _Optional[_Iterable[str]] = ..., timeout: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ..., levels: _Optional[int] = ..., domain_id: _Optional[str] = ..., workflow_id: _Optional[str] = ..., id: _Optional[str] = ...) -> None: ...
