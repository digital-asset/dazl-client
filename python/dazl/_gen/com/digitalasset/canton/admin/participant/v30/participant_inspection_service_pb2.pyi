...
class OpenCommitmentRequest(_message.Message):
    __slots__ = ("commitment", "physical_synchronizer_id", "computed_for_counter_participant_uid", "period_end_tick")
    ...
    def __init__(self, commitment: _Optional[bytes] = ..., physical_synchronizer_id: _Optional[str] = ..., computed_for_counter_participant_uid: _Optional[str] = ..., period_end_tick: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...
...
class CommitmentContract(_message.Message):
    __slots__ = ("cid", "active_on_expected_synchronizer", "contract", "states")
    CID_FIELD_NUMBER: _ClassVar[int]
...
class LookupReceivedAcsCommitmentsRequest(_message.Message):
    __slots__ = ("time_ranges", "counter_participant_ids", "commitment_state", "verbose")
...
class GetIntervalsBehindForCounterParticipantsRequest(_message.Message):
    __slots__ = ("counter_participant_ids", "synchronizer_ids", "threshold")
    COUNTER_PARTICIPANT_IDS_FIELD_NUMBER: _ClassVar[int]
    SYNCHRONIZER_IDS_FIELD_NUMBER: _ClassVar[int]
    ...
    synchronizer_ids: _containers.RepeatedScalarFieldContainer[str]
    threshold: int
    def __init__(self, counter_participant_ids: _Optional[_Iterable[str]] = ..., synchronizer_ids: _Optional[_Iterable[str]] = ..., threshold: _Optional[int] = ...) -> None: ...
