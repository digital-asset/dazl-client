...
class GetSafePruningOffsetResponse(_message.Message):
    ...
    safe_pruning_offset: int
    no_safe_pruning_offset: GetSafePruningOffsetResponse.NoSafePruningOffset
    def __init__(self, safe_pruning_offset: _Optional[int] = ..., no_safe_pruning_offset: _Optional[_Union[GetSafePruningOffsetResponse.NoSafePruningOffset, _Mapping]] = ...) -> None: ...
