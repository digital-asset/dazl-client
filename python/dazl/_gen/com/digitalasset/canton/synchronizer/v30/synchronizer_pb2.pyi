...
class SynchronizerPredecessor(_message.Message):
    ...
    def __init__(self, predecessor_physical_id: _Optional[str] = ..., upgrade_time: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., is_late_upgrade: bool = ...) -> None: ...
