...
class InitializeMediatorRequest(_message.Message):
    __slots__ = ("physical_synchronizer_id", "sequencer_connections", "sequencer_connection_validation")
    ...
    def __init__(self, physical_synchronizer_id: _Optional[str] = ..., sequencer_connections: _Optional[_Union[_sequencer_connection_pb2.SequencerConnections, _Mapping]] = ..., sequencer_connection_validation: _Optional[_Union[_sequencer_connection_pb2.SequencerConnectionValidation, str]] = ...) -> None: ...
