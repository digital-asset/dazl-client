...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in com/digitalasset/canton/domain/api/v0/domain_service_pb2_grpc.py depends on'
...
class DomainServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetServiceAgreement = channel.unary_unary(
                '/com.digitalasset.canton.domain.api.v0.DomainService/GetServiceAgreement',
...
def add_DomainServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'com.digitalasset.canton.domain.api.v0.DomainService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('com.digitalasset.canton.domain.api.v0.DomainService', rpc_method_handlers)
