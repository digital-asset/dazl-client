...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in com/digitalasset/canton/domain/api/v0/sequencer_authentication_service_pb2_grpc.py depends on'
...
def add_SequencerAuthenticationServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('com.digitalasset.canton.domain.api.v0.SequencerAuthenticationService', rpc_method_handlers)
