...
class SequencerAuthenticationServiceStub:
    ...
    def Challenge(self, __1: Challenge.Request, *, timeout: _typing.Optional[float] = ..., metadata: _typing.Optional[_typing.Tuple[_typing.Tuple[str, str | bytes], ...]] = ..., credentials: _typing.Optional[_grpc.CallCredentials] = ..., wait_for_ready: _typing.Optional[bool] = ..., compression: _typing.Optional[_grpc.Compression] = ...) -> Challenge.Response | _grpc_aio.UnaryUnaryCall[_typing.Any, Challenge.Response]: ...
    def Authenticate(self, __1: Authentication.Request, *, timeout: _typing.Optional[float] = ..., metadata: _typing.Optional[_typing.Tuple[_typing.Tuple[str, str | bytes], ...]] = ..., credentials: _typing.Optional[_grpc.CallCredentials] = ..., wait_for_ready: _typing.Optional[bool] = ..., compression: _typing.Optional[_grpc.Compression] = ...) -> Authentication.Response | _grpc_aio.UnaryUnaryCall[_typing.Any, Authentication.Response]: ...

# noinspection PyPep8Naming,DuplicatedCode
class _SequencerAuthenticationServiceBlockingStub(SequencerAuthenticationServiceStub):
    def Challenge(self, __1: Challenge.Request, timeout: _typing.Optional[float] = ..., metadata: _typing.Optional[_typing.Tuple[_typing.Tuple[str, str | bytes], ...]] = ..., credentials: _typing.Optional[_grpc.CallCredentials] = ..., wait_for_ready: _typing.Optional[bool] = ..., compression: _typing.Optional[_grpc.Compression] = ...) -> Challenge.Response: ...
