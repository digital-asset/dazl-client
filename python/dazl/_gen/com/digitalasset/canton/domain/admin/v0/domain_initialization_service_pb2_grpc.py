...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in com/digitalasset/canton/domain/admin/v0/domain_initialization_service_pb2_grpc.py depends on'
...
def add_DomainInitializationServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('com.digitalasset.canton.domain.admin.v0.DomainInitializationService', rpc_method_handlers)
