...
class _EnterpriseMediatorAdministrationServiceBlockingStub(EnterpriseMediatorAdministrationServiceStub):
    def Prune(self, __1: MediatorPruningRequest, timeout: _typing.Optional[float] = ..., metadata: _typing.Optional[_typing.Tuple[_typing.Tuple[str, _typing.Union[str, bytes]], ...]] = ..., credentials: _typing.Optional[_grpc.CallCredentials] = ..., wait_for_ready: _typing.Optional[bool] = ..., compression: _typing.Optional[_grpc.Compression] = ...) -> Empty: ...
