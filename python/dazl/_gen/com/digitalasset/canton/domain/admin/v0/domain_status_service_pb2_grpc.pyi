...
class DomainStatusServiceStub:
    ...
    def DomainStatus(self, __1: DomainStatusRequest, *, timeout: _typing.Optional[float] = ..., metadata: _typing.Optional[_typing.Tuple[_typing.Tuple[str, str | bytes], ...]] = ..., credentials: _typing.Optional[_grpc.CallCredentials] = ..., wait_for_ready: _typing.Optional[bool] = ..., compression: _typing.Optional[_grpc.Compression] = ...) -> DomainStatusResponse | _grpc_aio.UnaryUnaryCall[_typing.Any, DomainStatusResponse]: ...

# noinspection PyPep8Naming,DuplicatedCode
class _DomainStatusServiceBlockingStub(DomainStatusServiceStub):
    def DomainStatus(self, __1: DomainStatusRequest, timeout: _typing.Optional[float] = ..., metadata: _typing.Optional[_typing.Tuple[_typing.Tuple[str, str | bytes], ...]] = ..., credentials: _typing.Optional[_grpc.CallCredentials] = ..., wait_for_ready: _typing.Optional[bool] = ..., compression: _typing.Optional[_grpc.Compression] = ...) -> DomainStatusResponse: ...
