...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in com/digitalasset/canton/domain/admin/v0/enterprise_mediator_administration_service_pb2_grpc.py depends on'
...
def add_EnterpriseMediatorAdministrationServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('com.digitalasset.canton.domain.admin.v0.EnterpriseMediatorAdministrationService', rpc_method_handlers)
