...
class ListDomainParametersChangesResult(_message.Message):
    ...
    class Result(_message.Message):
        ...
        v2: _domain_params_pb2.DynamicDomainParameters
        def __init__(self, context: _Optional[_Union[BaseResult, _Mapping]] = ..., v0: _Optional[_Union[_sequencing_pb2.DynamicDomainParameters, _Mapping]] = ..., v1: _Optional[_Union[_sequencing_pb2_1.DynamicDomainParameters, _Mapping]] = ..., v2: _Optional[_Union[_domain_params_pb2.DynamicDomainParameters, _Mapping]] = ...) -> None: ...
    RESULTS_FIELD_NUMBER: _ClassVar[int]
