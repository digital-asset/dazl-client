...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in com/digitalasset/canton/topology/admin/v0/topology_aggregation_service_pb2_grpc.py depends on'
...
def add_TopologyAggregationServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('com.digitalasset.canton.topology.admin.v0.TopologyAggregationService', rpc_method_handlers)
