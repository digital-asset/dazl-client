...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in com/digitalasset/canton/participant/admin/v0/enterprise_participant_replication_service_pb2_grpc.py depends on'
...
def add_EnterpriseParticipantReplicationServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('com.digitalasset.canton.participant.admin.v0.EnterpriseParticipantReplicationService', rpc_method_handlers)
