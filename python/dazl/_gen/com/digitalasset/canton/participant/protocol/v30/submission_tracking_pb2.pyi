...
class TransactionSubmissionTrackingData(_message.Message):
    ...
    domain_id: str
    def __init__(self, completion_info: _Optional[_Union[_ledger_sync_event_pb2.CompletionInfo, _Mapping]] = ..., rejection_cause: _Optional[_Union[TransactionSubmissionTrackingData.RejectionCause, _Mapping]] = ..., domain_id: _Optional[str] = ...) -> None: ...
