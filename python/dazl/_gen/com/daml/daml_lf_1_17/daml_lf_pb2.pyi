...
class ArchivePayload(_message.Message):
    __slots__ = ("minor", "daml_lf_1", "daml_lf_2")
    ...
    daml_lf_2: bytes
    def __init__(self, minor: _Optional[str] = ..., daml_lf_1: _Optional[_Union[_daml_lf_1_pb2.Package, _Mapping]] = ..., daml_lf_2: _Optional[bytes] = ...) -> None: ...
