...
class BuiltinFunction(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    MUL_NUMERIC_LEGACY: _ClassVar[BuiltinFunction]
    MUL_NUMERIC: _ClassVar[BuiltinFunction]
    DIV_NUMERIC_LEGACY: _ClassVar[BuiltinFunction]
    DIV_NUMERIC: _ClassVar[BuiltinFunction]
    ROUND_NUMERIC: _ClassVar[BuiltinFunction]
    CAST_NUMERIC_LEGACY: _ClassVar[BuiltinFunction]
    CAST_NUMERIC: _ClassVar[BuiltinFunction]
    SHIFT_NUMERIC_LEGACY: _ClassVar[BuiltinFunction]
    ...
    TEXT_TO_NUMERIC_LEGACY: _ClassVar[BuiltinFunction]
    ...
    INT64_TO_NUMERIC_LEGACY: _ClassVar[BuiltinFunction]
    ...
    BIGNUMERIC_TO_NUMERIC_LEGACY: _ClassVar[BuiltinFunction]
...
MUL_NUMERIC_LEGACY: BuiltinFunction
MUL_NUMERIC: BuiltinFunction
DIV_NUMERIC_LEGACY: BuiltinFunction
DIV_NUMERIC: BuiltinFunction
ROUND_NUMERIC: BuiltinFunction
CAST_NUMERIC_LEGACY: BuiltinFunction
CAST_NUMERIC: BuiltinFunction
SHIFT_NUMERIC_LEGACY: BuiltinFunction
...
TEXT_TO_NUMERIC_LEGACY: BuiltinFunction
...
INT64_TO_NUMERIC_LEGACY: BuiltinFunction
...
BIGNUMERIC_TO_NUMERIC_LEGACY: BuiltinFunction
...
class PackageRef(_message.Message):
    ...
    def __init__(self_, self: _Optional[_Union[Unit, _Mapping]] = ..., package_id_str: _Optional[str] = ..., package_id_interned_str: _Optional[int] = ...) -> None: ...
...
class TemplateChoice(_message.Message):
    __slots__ = ("name_str", "name_interned_str", "consuming", "controllers", "observers", "authorizers", "arg_binder", "ret_type", "update", "self_binder_str", "self_binder_interned_str", "location")
...
class DefInterface(_message.Message):
    ...
    class CoImplements(_message.Message):
        __slots__ = ("template", "body", "location")
        TEMPLATE_FIELD_NUMBER: _ClassVar[int]
        BODY_FIELD_NUMBER: _ClassVar[int]
        LOCATION_FIELD_NUMBER: _ClassVar[int]
        template: TypeConName
        body: InterfaceInstanceBody
        location: Location
        def __init__(self, template: _Optional[_Union[TypeConName, _Mapping]] = ..., body: _Optional[_Union[InterfaceInstanceBody, _Mapping]] = ..., location: _Optional[_Union[Location, _Mapping]] = ...) -> None: ...
    LOCATION_FIELD_NUMBER: _ClassVar[int]
    TYCON_INTERNED_DNAME_FIELD_NUMBER: _ClassVar[int]
    METHODS_FIELD_NUMBER: _ClassVar[int]
    PARAM_INTERNED_STR_FIELD_NUMBER: _ClassVar[int]
