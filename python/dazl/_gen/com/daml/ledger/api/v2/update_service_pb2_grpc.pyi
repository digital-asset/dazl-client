...
class UpdateServiceStub:
    ...
    def GetUpdatesPage(self, __1: GetUpdatesPageRequest, *, timeout: _typing.Optional[float] = ..., metadata: _typing.Optional[_typing.Tuple[_typing.Tuple[str, str | bytes], ...]] = ..., credentials: _typing.Optional[_grpc.CallCredentials] = ..., wait_for_ready: _typing.Optional[bool] = ..., compression: _typing.Optional[_grpc.Compression] = ...) -> GetUpdatesPageResponse | _grpc_aio.UnaryUnaryCall[_typing.Any, GetUpdatesPageResponse]: ...
...
class _UpdateServiceAsyncStub(UpdateServiceStub):
    ...
    def GetUpdatesPage(self, __1: GetUpdatesPageRequest, *, timeout: _typing.Optional[float] = ..., metadata: _typing.Optional[_grpc_aio.Metadata] = ..., credentials: _typing.Optional[_grpc.CallCredentials] = ..., wait_for_ready: _typing.Optional[bool] = ..., compression: _typing.Optional[_grpc.Compression] = ...) -> _grpc_aio.UnaryUnaryCall[_typing.Any, GetUpdatesPageResponse]: ...  # type: ignore
