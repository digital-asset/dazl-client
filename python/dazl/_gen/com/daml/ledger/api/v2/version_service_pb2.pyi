...
class FeaturesDescriptor(_message.Message):
    __slots__ = ("experimental", "user_management", "party_management", "offset_checkpoint", "package_feature")
    ...
    PACKAGE_FEATURE_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, experimental: _Optional[_Union[_experimental_features_pb2.ExperimentalFeatures, _Mapping]] = ..., user_management: _Optional[_Union[UserManagementFeature, _Mapping]] = ..., party_management: _Optional[_Union[PartyManagementFeature, _Mapping]] = ..., offset_checkpoint: _Optional[_Union[OffsetCheckpointFeature, _Mapping]] = ..., package_feature: _Optional[_Union[PackageFeature, _Mapping]] = ...) -> None: ...
...
class PackageFeature(_message.Message):
    __slots__ = ("max_vetted_packages_page_size",)
    MAX_VETTED_PACKAGES_PAGE_SIZE_FIELD_NUMBER: _ClassVar[int]
    max_vetted_packages_page_size: int
    def __init__(self, max_vetted_packages_page_size: _Optional[int] = ...) -> None: ...
