...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in com/daml/ledger/api/v2/command_completion_service_pb2_grpc.py depends on'
...
def add_CommandCompletionServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('com.daml.ledger.api.v2.CommandCompletionService', rpc_method_handlers)
