...
class UnassignedEvent(_message.Message):
    __slots__ = ("reassignment_id", "contract_id", "template_id", "source", "target", "submitter", "reassignment_counter", "assignment_exclusivity", "witness_parties", "package_name", "offset", "node_id")
...
class AssignedEvent(_message.Message):
    ...
    def __init__(self, source: _Optional[str] = ..., target: _Optional[str] = ..., reassignment_id: _Optional[str] = ..., submitter: _Optional[str] = ..., reassignment_counter: _Optional[int] = ..., created_event: _Optional[_Union[_event_pb2.CreatedEvent, _Mapping]] = ...) -> None: ...
