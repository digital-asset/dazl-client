...
from .package_management_service_pb2 import ListKnownPackagesRequest, ListKnownPackagesResponse, UpdateVettedPackagesRequest, UpdateVettedPackagesResponse, UploadDarFileRequest, UploadDarFileResponse, ValidateDarFileRequest, ValidateDarFileResponse
...
class PackageManagementServiceStub:
    ...
    def ListKnownPackages(self, __1: ListKnownPackagesRequest, *, timeout: _typing.Optional[float] = ..., metadata: _typing.Optional[_typing.Tuple[_typing.Tuple[str, str | bytes], ...]] = ..., credentials: _typing.Optional[_grpc.CallCredentials] = ..., wait_for_ready: _typing.Optional[bool] = ..., compression: _typing.Optional[_grpc.Compression] = ...) -> ListKnownPackagesResponse | _grpc_aio.UnaryUnaryCall[_typing.Any, ListKnownPackagesResponse]: ...
    def UploadDarFile(self, __1: UploadDarFileRequest, *, timeout: _typing.Optional[float] = ..., metadata: _typing.Optional[_typing.Tuple[_typing.Tuple[str, str | bytes], ...]] = ..., credentials: _typing.Optional[_grpc.CallCredentials] = ..., wait_for_ready: _typing.Optional[bool] = ..., compression: _typing.Optional[_grpc.Compression] = ...) -> UploadDarFileResponse | _grpc_aio.UnaryUnaryCall[_typing.Any, UploadDarFileResponse]: ...
    def ValidateDarFile(self, __1: ValidateDarFileRequest, *, timeout: _typing.Optional[float] = ..., metadata: _typing.Optional[_typing.Tuple[_typing.Tuple[str, str | bytes], ...]] = ..., credentials: _typing.Optional[_grpc.CallCredentials] = ..., wait_for_ready: _typing.Optional[bool] = ..., compression: _typing.Optional[_grpc.Compression] = ...) -> ValidateDarFileResponse | _grpc_aio.UnaryUnaryCall[_typing.Any, ValidateDarFileResponse]: ...
    def UpdateVettedPackages(self, __1: UpdateVettedPackagesRequest, *, timeout: _typing.Optional[float] = ..., metadata: _typing.Optional[_typing.Tuple[_typing.Tuple[str, str | bytes], ...]] = ..., credentials: _typing.Optional[_grpc.CallCredentials] = ..., wait_for_ready: _typing.Optional[bool] = ..., compression: _typing.Optional[_grpc.Compression] = ...) -> UpdateVettedPackagesResponse | _grpc_aio.UnaryUnaryCall[_typing.Any, UpdateVettedPackagesResponse]: ...
...
class _PackageManagementServiceAsyncStub(PackageManagementServiceStub):
    ...
    def UpdateVettedPackages(self, __1: UpdateVettedPackagesRequest, *, timeout: _typing.Optional[float] = ..., metadata: _typing.Optional[_grpc_aio.Metadata] = ..., credentials: _typing.Optional[_grpc.CallCredentials] = ..., wait_for_ready: _typing.Optional[bool] = ..., compression: _typing.Optional[_grpc.Compression] = ...) -> _grpc_aio.UnaryUnaryCall[_typing.Any, UpdateVettedPackagesResponse]: ...  # type: ignore
