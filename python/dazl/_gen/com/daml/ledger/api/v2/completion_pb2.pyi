...
class Completion(_message.Message):
    __slots__ = ("command_id", "status", "update_id", "application_id", "act_as", "submission_id", "deduplication_offset", "deduplication_duration", "trace_context", "offset", "domain_time")
    ...
    DOMAIN_TIME_FIELD_NUMBER: _ClassVar[int]
    command_id: str
    ...
    offset: int
    domain_time: _offset_checkpoint_pb2.DomainTime
    def __init__(self, command_id: _Optional[str] = ..., status: _Optional[_Union[_status_pb2.Status, _Mapping]] = ..., update_id: _Optional[str] = ..., application_id: _Optional[str] = ..., act_as: _Optional[_Iterable[str]] = ..., submission_id: _Optional[str] = ..., deduplication_offset: _Optional[int] = ..., deduplication_duration: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ..., trace_context: _Optional[_Union[_trace_context_pb2.TraceContext, _Mapping]] = ..., offset: _Optional[int] = ..., domain_time: _Optional[_Union[_offset_checkpoint_pb2.DomainTime, _Mapping]] = ...) -> None: ...
