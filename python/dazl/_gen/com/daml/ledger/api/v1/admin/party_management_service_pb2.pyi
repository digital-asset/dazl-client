...
class GetPartiesRequest(__Message):
    parties: __List[str]
    def __init__(self, *, parties: __Optional[__Sequence[str]] = ...): ...
    def __eq__(self, other_msg: __Optional[__Any]) -> bool: ...
    def __str__(self) -> str: ...
    def __unicode__(self) -> str: ...
...
class AllocatePartyRequest(__Message):
    party_id_hint: str
    display_name: str
    def __init__(self, *, party_id_hint: __Optional[str] = ..., display_name: __Optional[str] = ...): ...
    def __eq__(self, other_msg: __Optional[__Any]) -> bool: ...
    def __str__(self) -> str: ...
    def __unicode__(self) -> str: ...
...
class PartyDetails(__Message):
    ...
    display_name: str
    is_local: bool
    def __init__(self, *, party: __Optional[str] = ..., display_name: __Optional[str] = ..., is_local: __Optional[bool] = ...): ...
    def __eq__(self, other_msg: __Optional[__Any]) -> bool: ...
    def __str__(self) -> str: ...
    def __unicode__(self) -> str: ...
