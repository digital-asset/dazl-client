...
class ExperimentalFeatures(_Message):
    ...
    def HasField(self, field_name: _L["self_service_error_codes", "static_time", "command_deduplication", "optional_ledger_id", "contract_ids", "committer_event_log", "explicit_disclosure"]) -> _builtins.bool: ...
    def ClearField(self, field_name: _L["self_service_error_codes", "static_time", "command_deduplication", "optional_ledger_id", "contract_ids", "committer_event_log", "explicit_disclosure"]) -> None: ...
