...
class TransactionTree(_message.Message):
    __slots__ = ("transaction_id", "command_id", "workflow_id", "effective_at", "offset", "events_by_id", "root_event_ids", "trace_context")
...
class Transaction(_message.Message):
    __slots__ = ("transaction_id", "command_id", "workflow_id", "effective_at", "events", "offset", "trace_context")
    TRANSACTION_ID_FIELD_NUMBER: _ClassVar[int]
    COMMAND_ID_FIELD_NUMBER: _ClassVar[int]
    WORKFLOW_ID_FIELD_NUMBER: _ClassVar[int]
    EFFECTIVE_AT_FIELD_NUMBER: _ClassVar[int]
