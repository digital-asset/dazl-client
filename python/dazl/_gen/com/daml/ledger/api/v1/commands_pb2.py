...
_COMMANDS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\030\001', json_name='deduplicationTime', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='deduplication_duration', full_name='com.daml.ledger.api.v1.Commands.deduplication_duration', index=7,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='deduplication_period', full_name='com.daml.ledger.api.v1.Commands.deduplication_period',
...
_COMMANDS.fields_by_name['deduplication_duration'].message_type = google_dot_protobuf_dot_duration__pb2._DURATION
...
_COMMANDS.oneofs_by_name['deduplication_period'].fields.append(
  _COMMANDS.fields_by_name['deduplication_time'])
_COMMANDS.fields_by_name['deduplication_time'].containing_oneof = _COMMANDS.oneofs_by_name['deduplication_period']
_COMMANDS.oneofs_by_name['deduplication_period'].fields.append(
