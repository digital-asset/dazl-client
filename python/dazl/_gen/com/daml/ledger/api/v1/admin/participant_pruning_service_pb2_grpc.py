...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in com/daml/ledger/api/v1/admin/participant_pruning_service_pb2_grpc.py depends on'
...
def add_ParticipantPruningServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('com.daml.ledger.api.v1.admin.ParticipantPruningService', rpc_method_handlers)
