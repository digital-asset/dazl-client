...
class ListUsersResponse(_Message):
    ...
    def __init__(self, *, users: _typing.Optional[_typing.Iterable[User]] = ...): ...
    def HasField(self, field_name: _L["users"]) -> _builtins.bool: ...
    def ClearField(self, field_name: _L["users"]) -> None: ...
    def WhichOneof(self, oneof_group: _typing.NoReturn) -> _typing.NoReturn: ...
