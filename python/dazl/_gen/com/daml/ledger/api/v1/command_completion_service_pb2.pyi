...
class CompletionStreamRequest(_Message):
    ...
    def HasField(self, field_name: _typing.Literal["ledger_id", "application_id", "parties", "offset"]) -> _builtins.bool: ...
...
class CompletionStreamResponse(_Message):
    ...
    def HasField(self, field_name: _typing.Literal["checkpoint", "completions"]) -> _builtins.bool: ...
...
class Checkpoint(_Message):
    ...
    def HasField(self, field_name: _typing.Literal["record_time", "offset"]) -> _builtins.bool: ...
