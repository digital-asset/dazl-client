...
class GetPackageRequest(_Message):
    ...
    @property
    def trace_context(self) -> TraceContext: ...
    def __init__(self, *, ledger_id: _typing.Optional[_builtins.str] = ..., package_id: _typing.Optional[_builtins.str] = ..., trace_context: _typing.Optional[TraceContext] = ...): ...
    def HasField(self, field_name: _L["ledger_id", "package_id", "trace_context"]) -> _builtins.bool: ...
    def ClearField(self, field_name: _L["ledger_id", "package_id", "trace_context"]) -> None: ...
    def WhichOneof(self, oneof_group: _typing.NoReturn) -> _typing.NoReturn: ...
