...
class ListPackagesResponse(__Message):
    package_ids: __List[str]
    def __init__(self, *, package_ids: __Optional[__Sequence[str]] = ...): ...
    def __eq__(self, other_msg: __Optional[__Any]) -> bool: ...
    def __str__(self) -> str: ...
    def __unicode__(self) -> str: ...
...
class GetPackageRequest(__Message):
    ...
    package_id: str
    trace_context: TraceContext
    def __init__(self, *, ledger_id: __Optional[str] = ..., package_id: __Optional[str] = ..., trace_context: __Optional[TraceContext] = ...): ...
    def __eq__(self, other_msg: __Optional[__Any]) -> bool: ...
    def __str__(self) -> str: ...
    def __unicode__(self) -> str: ...
...
class GetPackageResponse(__Message):
    ...
    hash: str
    def __init__(self, *, hash_function: __Optional[__Literal[0]] = ..., archive_payload: __Optional[bytes] = ..., hash: __Optional[str] = ...): ...
    def __eq__(self, other_msg: __Optional[__Any]) -> bool: ...
    def __str__(self) -> str: ...
    def __unicode__(self) -> str: ...
