...
_COMPLETION = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="command_id",
            full_name="com.daml.ledger.api.v1.Completion.command_id",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="status",
            full_name="com.daml.ledger.api.v1.Completion.status",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="transaction_id",
            full_name="com.daml.ledger.api.v1.Completion.transaction_id",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="trace_context",
            full_name="com.daml.ledger.api.v1.Completion.trace_context",
            index=3,
            number=1000,
            type=11,
            cpp_type=10,
...
Completion = _reflection.GeneratedProtocolMessageType(
    "Completion",
    (_message.Message,),
    {
