...
class GetLedgerIdentityRequest(__Message):
    ...
    def HasField(self, field_name: __Literal["trace_context"]) -> bool: ...
    def ClearField(self, field_name: __Literal["trace_context"]) -> None: ...
...
class GetLedgerIdentityResponse(__Message):
    ledger_id: str
    def __init__(self, ledger_id: str = ...): ...
    def __eq__(self, other_msg: __Optional[__Any]) -> bool: ...
    def __str__(self) -> str: ...
    def __unicode__(self) -> str: ...
    def MergeFrom(self, other_msg: GetLedgerIdentityResponse) -> None: ...
    def Clear(self) -> None: ...
    def SetInParent(self) -> None: ...
    def IsInitialized(self) -> bool: ...
    def MergeFromString(self, serialized: bytes) -> int: ...
    ...
    def SerializePartialToString(self, *, deterministic: bool = ...) -> bytes: ...
    def ListFields(self) -> __Sequence[__Tuple[__FieldDescriptor, __Any]]: ...
    def HasField(self, field_name: __Literal["ledger_id"]) -> bool: ...
    def ClearField(self, field_name: __Literal["ledger_id"]) -> None: ...
    def WhichOneof(self, oneof_group: __Void) -> __Void: ...
    def HasExtension(self, extension_handle: __Any) -> bool: ...
    def ClearExtension(self, extension_handle: __Any) -> None: ...
    def UnknownFields(self) -> __Any: ...
