...
class InterfaceFilter(_Message):
    ...
    def __init__(self, *, interface_id: _typing.Optional[Identifier] = ..., include_interface_view: _typing.Optional[_builtins.bool] = ...): ...
    def HasField(self, field_name: _L["interface_id", "include_interface_view"]) -> _builtins.bool: ...
    def ClearField(self, field_name: _L["interface_id", "include_interface_view"]) -> None: ...
    def WhichOneof(self, oneof_group: _typing.NoReturn) -> _typing.NoReturn: ...
