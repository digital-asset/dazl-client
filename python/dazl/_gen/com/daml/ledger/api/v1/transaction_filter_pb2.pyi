...
class InclusiveFilters(_message.Message):
    __slots__ = ("template_ids", "interface_filters", "template_filters")
    ...
    template_filters: _containers.RepeatedCompositeFieldContainer[TemplateFilter]
    def __init__(self, template_ids: _Optional[_Iterable[_Union[_value_pb2.Identifier, _Mapping]]] = ..., interface_filters: _Optional[_Iterable[_Union[InterfaceFilter, _Mapping]]] = ..., template_filters: _Optional[_Iterable[_Union[TemplateFilter, _Mapping]]] = ...) -> None: ...
