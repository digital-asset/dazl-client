...
class TransactionFilter(__Message):
    ...
    def __init__(self, filters_by_party: __Mapping[Party, Filters] = ...): ...
    ...
    def HasField(self, field_name: __Literal["filters_by_party"]) -> bool: ...
    def ClearField(self, field_name: __Literal["filters_by_party"]) -> None: ...
...
class Filters(__Message):
    inclusive: InclusiveFilters
    def __init__(self, inclusive: InclusiveFilters = ...): ...
    def __eq__(self, other_msg: __Optional[__Any]) -> bool: ...
    def __str__(self) -> str: ...
    def __unicode__(self) -> str: ...
    ...
    def SerializePartialToString(self, *, deterministic: bool = ...) -> bytes: ...
    def ListFields(self) -> __Sequence[__Tuple[__FieldDescriptor, __Any]]: ...
    def HasField(self, field_name: __Literal["inclusive"]) -> bool: ...
    def ClearField(self, field_name: __Literal["inclusive"]) -> None: ...
    def WhichOneof(self, oneof_group: __Void) -> __Void: ...
    def HasExtension(self, extension_handle: __Any) -> bool: ...
    def ClearExtension(self, extension_handle: __Any) -> None: ...
    def UnknownFields(self) -> __Any: ...
...
class InclusiveFilters(__Message):
    template_ids: __List[Identifier]
    def __init__(self, template_ids: __Sequence[Identifier] = ...): ...
    def __eq__(self, other_msg: __Optional[__Any]) -> bool: ...
    def __str__(self) -> str: ...
    def __unicode__(self) -> str: ...
    ...
    def SerializePartialToString(self, *, deterministic: bool = ...) -> bytes: ...
    def ListFields(self) -> __Sequence[__Tuple[__FieldDescriptor, __Any]]: ...
    def HasField(self, field_name: __Literal["template_ids"]) -> bool: ...
    def ClearField(self, field_name: __Literal["template_ids"]) -> None: ...
    def WhichOneof(self, oneof_group: __Void) -> __Void: ...
    def HasExtension(self, extension_handle: __Any) -> bool: ...
    def ClearExtension(self, extension_handle: __Any) -> None: ...
    def UnknownFields(self) -> __Any: ...
