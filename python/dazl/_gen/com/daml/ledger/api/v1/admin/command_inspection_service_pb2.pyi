...
class CommandState(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    STATE_UNSPECIFIED: _ClassVar[CommandState]
    STATE_PENDING: _ClassVar[CommandState]
    STATE_SUCCEEDED: _ClassVar[CommandState]
    STATE_FAILED: _ClassVar[CommandState]
STATE_UNSPECIFIED: CommandState
STATE_PENDING: CommandState
STATE_SUCCEEDED: CommandState
STATE_FAILED: CommandState
...
class GetCommandStatusResponse(_message.Message):
    ...
    class CommandStatus(_message.Message):
        ...
        class CommandUpdates(_message.Message):
            ...
            created: _containers.RepeatedCompositeFieldContainer[GetCommandStatusResponse.CommandStatus.CommandUpdates.Contract]
            archived: _containers.RepeatedCompositeFieldContainer[GetCommandStatusResponse.CommandStatus.CommandUpdates.Contract]
            exercised: int
            fetched: int
            looked_up_by_key: int
            def __init__(self, created: _Optional[_Iterable[_Union[GetCommandStatusResponse.CommandStatus.CommandUpdates.Contract, _Mapping]]] = ..., archived: _Optional[_Iterable[_Union[GetCommandStatusResponse.CommandStatus.CommandUpdates.Contract, _Mapping]]] = ..., exercised: _Optional[int] = ..., fetched: _Optional[int] = ..., looked_up_by_key: _Optional[int] = ...) -> None: ...
