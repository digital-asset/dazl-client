...
class ParticipantMeteringReport(_Message):
    ...
    @property
    def to_actual(self) -> Timestamp: ...
    @property
    def application_reports(self) -> RepeatedCompositeFieldContainer[ApplicationMeteringReport]: ...
    def __init__(self, *, participant_id: _typing.Optional[_builtins.str] = ..., to_actual: _typing.Optional[Timestamp] = ..., application_reports: _typing.Optional[_typing.Iterable[ApplicationMeteringReport]] = ...): ...
    def HasField(self, field_name: _L["participant_id", "to_actual", "application_reports"]) -> _builtins.bool: ...
    def ClearField(self, field_name: _L["participant_id", "to_actual", "application_reports"]) -> None: ...
    def WhichOneof(self, oneof_group: _typing.NoReturn) -> _typing.NoReturn: ...
