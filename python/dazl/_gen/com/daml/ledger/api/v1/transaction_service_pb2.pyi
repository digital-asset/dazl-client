...
class GetTransactionsRequest(_message.Message):
    __slots__ = ("ledger_id", "begin", "end", "filter", "verbose", "send_pruned_offsets")
    LEDGER_ID_FIELD_NUMBER: _ClassVar[int]
    BEGIN_FIELD_NUMBER: _ClassVar[int]
    END_FIELD_NUMBER: _ClassVar[int]
    FILTER_FIELD_NUMBER: _ClassVar[int]
    VERBOSE_FIELD_NUMBER: _ClassVar[int]
    SEND_PRUNED_OFFSETS_FIELD_NUMBER: _ClassVar[int]
    ledger_id: str
...
class GetTransactionsResponse(_message.Message):
    ...
    PRUNED_OFFSET_FIELD_NUMBER: _ClassVar[int]
    transactions: _containers.RepeatedCompositeFieldContainer[_transaction_pb2.Transaction]
    pruned_offset: str
    def __init__(self, transactions: _Optional[_Iterable[_Union[_transaction_pb2.Transaction, _Mapping]]] = ..., pruned_offset: _Optional[str] = ...) -> None: ...
...
class GetTransactionTreesResponse(_message.Message):
    ...
    pruned_offset: str
    def __init__(self, transactions: _Optional[_Iterable[_Union[_transaction_pb2.TransactionTree, _Mapping]]] = ..., pruned_offset: _Optional[str] = ...) -> None: ...
