...
class GetTransactionsRequest(_Message):
    ...
    def __init__(self, *, ledger_id: _typing.Optional[_builtins.str] = ..., begin: _typing.Optional[LedgerOffset] = ..., end: _typing.Optional[LedgerOffset] = ..., filter: _typing.Optional[TransactionFilter] = ..., verbose: _typing.Optional[_builtins.bool] = ..., trace_context: _typing.Optional[TraceContext] = ...): ...
    def HasField(self, field_name: _L["ledger_id", "begin", "end", "filter", "verbose", "trace_context"]) -> _builtins.bool: ...
    def ClearField(self, field_name: _L["ledger_id", "begin", "end", "filter", "verbose", "trace_context"]) -> None: ...
...
class GetTransactionByEventIdRequest(_Message):
    ...
    @property
    def trace_context(self) -> TraceContext: ...
    def __init__(self, *, ledger_id: _typing.Optional[_builtins.str] = ..., event_id: _typing.Optional[_builtins.str] = ..., requesting_parties: _typing.Optional[_typing.Iterable[_builtins.str]] = ..., trace_context: _typing.Optional[TraceContext] = ...): ...
    def HasField(self, field_name: _L["ledger_id", "event_id", "requesting_parties", "trace_context"]) -> _builtins.bool: ...
    def ClearField(self, field_name: _L["ledger_id", "event_id", "requesting_parties", "trace_context"]) -> None: ...
    def WhichOneof(self, oneof_group: _typing.NoReturn) -> _typing.NoReturn: ...
...
class GetTransactionByIdRequest(_Message):
    ...
    @property
    def trace_context(self) -> TraceContext: ...
    def __init__(self, *, ledger_id: _typing.Optional[_builtins.str] = ..., transaction_id: _typing.Optional[_builtins.str] = ..., requesting_parties: _typing.Optional[_typing.Iterable[_builtins.str]] = ..., trace_context: _typing.Optional[TraceContext] = ...): ...
    def HasField(self, field_name: _L["ledger_id", "transaction_id", "requesting_parties", "trace_context"]) -> _builtins.bool: ...
    def ClearField(self, field_name: _L["ledger_id", "transaction_id", "requesting_parties", "trace_context"]) -> None: ...
    def WhichOneof(self, oneof_group: _typing.NoReturn) -> _typing.NoReturn: ...
...
class GetLedgerEndRequest(_Message):
    ...
    @property
    def trace_context(self) -> TraceContext: ...
    def __init__(self, *, ledger_id: _typing.Optional[_builtins.str] = ..., trace_context: _typing.Optional[TraceContext] = ...): ...
    def HasField(self, field_name: _L["ledger_id", "trace_context"]) -> _builtins.bool: ...
    def ClearField(self, field_name: _L["ledger_id", "trace_context"]) -> None: ...
    def WhichOneof(self, oneof_group: _typing.NoReturn) -> _typing.NoReturn: ...
