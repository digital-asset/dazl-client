...
class IdentityProviderConfig(_Message):
    ...
    def __init__(self, *, identity_provider_id: _typing.Optional[_builtins.str] = ..., is_deactivated: _typing.Optional[_builtins.bool] = ..., issuer: _typing.Optional[_builtins.str] = ..., jwks_url: _typing.Optional[_builtins.str] = ..., audience: _typing.Optional[_builtins.str] = ...): ...
    def HasField(self, field_name: _typing.Literal["identity_provider_id", "is_deactivated", "issuer", "jwks_url", "audience"]) -> _builtins.bool: ...
    def ClearField(self, field_name: _typing.Literal["identity_provider_id", "is_deactivated", "issuer", "jwks_url", "audience"]) -> None: ...
