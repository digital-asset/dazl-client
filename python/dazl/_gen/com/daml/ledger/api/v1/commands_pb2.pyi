...
class DisclosedContract(_Message):
    ...
    def HasField(self, field_name: _L["template_id", "contract_id", "arguments", "create_arguments", "create_arguments_blob", "metadata"]) -> _builtins.bool: ...
    def ClearField(self, field_name: _L["template_id", "contract_id", "arguments", "create_arguments", "create_arguments_blob", "metadata"]) -> None: ...
    def WhichOneof(self, oneof_group: _L["arguments"]) -> _L[None, "create_arguments", "create_arguments_blob"]: ...
