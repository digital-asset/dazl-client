...
class Commands(_Message):
    ...
    def HasField(self, field_name: _L["ledger_id", "workflow_id", "application_id", "command_id", "party", "commands", "deduplication_period", "deduplication_time", "deduplication_duration", "deduplication_offset", "min_ledger_time_abs", "min_ledger_time_rel", "act_as", "read_as", "submission_id", "disclosed_contracts"]) -> _builtins.bool: ...
    def ClearField(self, field_name: _L["ledger_id", "workflow_id", "application_id", "command_id", "party", "commands", "deduplication_period", "deduplication_time", "deduplication_duration", "deduplication_offset", "min_ledger_time_abs", "min_ledger_time_rel", "act_as", "read_as", "submission_id", "disclosed_contracts"]) -> None: ...
    def WhichOneof(self, oneof_group: _L["deduplication_period"]) -> _L[None, "deduplication_time", "deduplication_duration", "deduplication_offset"]: ...
...
class DisclosedContract(_Message):
    ...
    def __init__(self, *, template_id: _typing.Optional[Identifier] = ..., contract_id: _typing.Optional[_builtins.str] = ..., arguments: _typing.Optional[Record] = ..., metadata: _typing.Optional[ContractMetadata] = ...): ...
    def HasField(self, field_name: _L["template_id", "contract_id", "arguments", "metadata"]) -> _builtins.bool: ...
    def ClearField(self, field_name: _L["template_id", "contract_id", "arguments", "metadata"]) -> None: ...
    def WhichOneof(self, oneof_group: _typing.NoReturn) -> _typing.NoReturn: ...
