...
class TraceContext(__Message):
    trace_id_high: int
    trace_id: int
    span_id: int
    parent_span_id: UInt64Value
    sampled: bool
    def __init__(self, trace_id_high: int = ..., trace_id: int = ..., span_id: int = ..., parent_span_id: UInt64Value = ..., sampled: bool = ...): ...
    ...
    def HasField(self, field_name: __Literal["trace_id_high", "trace_id", "span_id", "parent_span_id", "sampled"]) -> bool: ...
    def ClearField(self, field_name: __Literal["trace_id_high", "trace_id", "span_id", "parent_span_id", "sampled"]) -> None: ...
