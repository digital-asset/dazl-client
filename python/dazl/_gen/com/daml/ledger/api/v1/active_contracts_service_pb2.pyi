...
class GetActiveContractsRequest(__Message):
    ...
    def __init__(self, ledger_id: str = ..., filter: TransactionFilter = ..., verbose: bool = ..., trace_context: TraceContext = ...): ...
...
class GetActiveContractsResponse(__Message):
    ...
    trace_context: TraceContext
    def __init__(self, offset: str = ..., workflow_id: str = ..., active_contracts: __Sequence[CreatedEvent] = ..., trace_context: TraceContext = ...): ...
    def __eq__(self, other_msg: __Optional[__Any]) -> bool: ...
    def __str__(self) -> str: ...
    def __unicode__(self) -> str: ...
