...
class SetTimeModelRequest(_Message):
    ...
    def __init__(self, *, submission_id: _typing.Optional[int] = ..., maximum_record_time: _typing.Optional[Timestamp] = ..., configuration_generation: _typing.Optional[int] = ..., new_time_model: _typing.Optional[TimeModel] = ...): ...
    def __eq__(self, other_msg: _typing.Optional[_typing.Any]) -> bool: ...
    def __str__(self) -> str: ...
    def __unicode__(self) -> str: ...
