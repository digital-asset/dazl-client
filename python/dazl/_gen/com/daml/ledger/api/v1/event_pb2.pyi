...
class CreatedEvent(_Message):
    ...
    def __init__(self, *, event_id: _typing.Optional[str] = ..., contract_id: _typing.Optional[str] = ..., template_id: _typing.Optional[Identifier] = ..., contract_key: _typing.Optional[Value] = ..., create_arguments: _typing.Optional[Record] = ..., witness_parties: _typing.Optional[_typing.Sequence[Party]] = ..., signatories: _typing.Optional[_typing.Sequence[Party]] = ..., observers: _typing.Optional[_typing.Sequence[Party]] = ..., agreement_text: StringValue = ...): ...
    def __eq__(self, other_msg: _typing.Optional[_typing.Any]) -> bool: ...
    def __str__(self) -> str: ...
    def __unicode__(self) -> str: ...
...
class ArchivedEvent(_Message):
    ...
    @property
    def witness_parties(self) -> RepeatedScalarFieldContainer[str]: ...
    def __init__(self, *, event_id: _typing.Optional[str] = ..., contract_id: _typing.Optional[str] = ..., template_id: _typing.Optional[Identifier] = ..., witness_parties: _typing.Optional[_typing.Sequence[Party]] = ...): ...
    def __eq__(self, other_msg: _typing.Optional[_typing.Any]) -> bool: ...
    def __str__(self) -> str: ...
    def __unicode__(self) -> str: ...
