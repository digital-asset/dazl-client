...
class CreatedEvent(_Message):
    ...
    def __init__(self, *, event_id: _typing.Optional[_builtins.str] = ..., contract_id: _typing.Optional[_builtins.str] = ..., template_id: _typing.Optional[Identifier] = ..., contract_key: _typing.Optional[Value] = ..., create_arguments: _typing.Optional[Record] = ..., interface_views: _typing.Optional[_typing.Iterable[InterfaceView]] = ..., witness_parties: _typing.Optional[_typing.Iterable[_builtins.str]] = ..., signatories: _typing.Optional[_typing.Iterable[_builtins.str]] = ..., observers: _typing.Optional[_typing.Iterable[_builtins.str]] = ..., agreement_text: _typing.Optional[StringValue] = ..., metadata: _typing.Optional[ContractMetadata] = ...): ...
    def HasField(self, field_name: _L["event_id", "contract_id", "template_id", "contract_key", "create_arguments", "interface_views", "witness_parties", "signatories", "observers", "agreement_text", "metadata"]) -> _builtins.bool: ...
    def ClearField(self, field_name: _L["event_id", "contract_id", "template_id", "contract_key", "create_arguments", "interface_views", "witness_parties", "signatories", "observers", "agreement_text", "metadata"]) -> None: ...
