...
class Event(__Message):
    ...
    def WhichOneof(self, oneof_group: __Literal["event"]) -> __Literal["created", "archived"]: ...
...
class CreatedEvent(__Message):
    ...
    def __init__(self, event_id: str = ..., contract_id: str = ..., template_id: Identifier = ..., contract_key: Value = ..., create_arguments: Record = ..., witness_parties: __Sequence[Party] = ...): ...
    def __eq__(self, other_msg: __Optional[__Any]) -> bool: ...
    def __str__(self) -> str: ...
    def __unicode__(self) -> str: ...
    ...
    def SerializePartialToString(self, *, deterministic: bool = ...) -> bytes: ...
    def ListFields(self) -> __Sequence[__Tuple[__FieldDescriptor, __Any]]: ...
    def HasField(self, field_name: __Literal["event_id", "contract_id", "template_id", "contract_key", "create_arguments", "witness_parties"]) -> bool: ...
    def ClearField(self, field_name: __Literal["event_id", "contract_id", "template_id", "contract_key", "create_arguments", "witness_parties"]) -> None: ...
...
class ArchivedEvent(__Message):
    ...
    template_id: Identifier
    witness_parties: __List[Party]
    def __init__(self, event_id: str = ..., contract_id: str = ..., template_id: Identifier = ..., witness_parties: __Sequence[Party] = ...): ...
    def __eq__(self, other_msg: __Optional[__Any]) -> bool: ...
    def __str__(self) -> str: ...
    def __unicode__(self) -> str: ...
...
class ExercisedEvent(__Message):
    ...
    def __init__(self, event_id: str = ..., contract_id: str = ..., template_id: Identifier = ..., choice: str = ..., choice_argument: Value = ..., acting_parties: __Sequence[Party] = ..., consuming: bool = ..., witness_parties: __Sequence[Party] = ..., child_event_ids: __Sequence[str] = ..., exercise_result: Value = ...): ...
    def __eq__(self, other_msg: __Optional[__Any]) -> bool: ...
    def __str__(self) -> str: ...
    def __unicode__(self) -> str: ...
