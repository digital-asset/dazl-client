...
class ListKnownPackagesResponse(_Message):
    ...
    def HasField(self, field_name: _typing.Literal["package_details"]) -> _builtins.bool: ...
...
class PackageDetails(_Message):
    ...
    def HasField(self, field_name: _typing.Literal["package_id", "package_size", "known_since", "source_description"]) -> _builtins.bool: ...
...
class UploadDarFileRequest(_Message):
    ...
    def HasField(self, field_name: _typing.Literal["dar_file", "submission_id"]) -> _builtins.bool: ...
