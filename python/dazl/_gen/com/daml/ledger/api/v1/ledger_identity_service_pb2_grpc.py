...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in com/daml/ledger/api/v1/ledger_identity_service_pb2_grpc.py depends on'
...
def add_LedgerIdentityServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('com.daml.ledger.api.v1.LedgerIdentityService', rpc_method_handlers)
