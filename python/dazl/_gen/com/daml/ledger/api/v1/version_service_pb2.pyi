...
class GetLedgerApiVersionResponse(_Message):
    ...
    def __init__(self, *, version: _typing.Optional[_builtins.str] = ...): ...
    def HasField(self, field_name: _L["version"]) -> _builtins.bool: ...
    def ClearField(self, field_name: _L["version"]) -> None: ...
    def WhichOneof(self, oneof_group: _typing.NoReturn) -> _typing.NoReturn: ...
