...
class Value(__Message):
    ...
    def WhichOneof(self, oneof_group: __Literal["Sum"]) -> __Literal["record", "variant", "contract_id", "list", "int64", "numeric", "text", "timestamp", "party", "bool", "unit", "date", "optional,", "map", "enum", "gen_map"]: ...
...
class Record(__Message):
    ...
    def __init__(self, record_id: Identifier = ..., fields: __Sequence[RecordField] = ...): ...
    def __eq__(self, other_msg: __Optional[__Any]) -> bool: ...
    def __str__(self) -> str: ...
    def __unicode__(self) -> str: ...
...
class Identifier(__Message):
    ...
    module_name: str
    entity_name: str
    def __init__(self, package_id: PackageRef = ..., module_name: str = ..., entity_name: str = ...): ...
    def __eq__(self, other_msg: __Optional[__Any]) -> bool: ...
    def __str__(self) -> str: ...
    def __unicode__(self) -> str: ...
...
class Variant(__Message):
    ...
    constructor: str
    value: Value
    def __init__(self, variant_id: Identifier = ..., constructor: str = ..., value: Value = ...): ...
    def __eq__(self, other_msg: __Optional[__Any]) -> bool: ...
    def __str__(self) -> str: ...
    def __unicode__(self) -> str: ...
...
class Enum(__Message):
    enum_id: Identifier
    constructor: str
    def __init__(self, enum_id: Identifier = ..., constructor: str = ...): ...
    def __eq__(self, other_msg: __Optional[__Any]) -> bool: ...
    def __str__(self) -> str: ...
    def __unicode__(self) -> str: ...
...
class List(__Message):
    ...
    def __init__(self, elements: __Sequence[Value] = ...): ...
    def __eq__(self, other_msg: __Optional[__Any]) -> bool: ...
    def __str__(self) -> str: ...
    def __unicode__(self) -> str: ...
...
class Map(__Message):
    ...
    def __init__(self, entries: __Sequence[Map.Entry] = ...): ...
    def __eq__(self, other_msg: __Optional[__Any]) -> bool: ...
    def __str__(self) -> str: ...
    def __unicode__(self) -> str: ...
...
class GenMap(__Message):
    ...
    def __init__(self, entries: __Sequence[GenMap.Entry] = ...): ...
    def __eq__(self, other_msg: __Optional[__Any]) -> bool: ...
    def __str__(self) -> str: ...
    def __unicode__(self) -> str: ...
    ...
    class Entry(__Message):
        key: Value
        value: Value
        def __init__(self, key: Value = ..., value: Value = ...): ...
        def __eq__(self, other_msg: __Optional[__Any]) -> bool: ...
        def __str__(self) -> str: ...
        def __unicode__(self) -> str: ...
