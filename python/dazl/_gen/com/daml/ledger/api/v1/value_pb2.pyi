...
class Value(_Message):
    ...
    def HasField(self, field_name: _typing.Literal["Sum", "record", "variant", "contract_id", "list", "int64", "numeric", "text", "timestamp", "party", "bool", "unit", "date", "optional", "map", "enum", "gen_map"]) -> _builtins.bool: ...
...
class Record(_Message):
    ...
    def HasField(self, field_name: _typing.Literal["record_id", "fields"]) -> _builtins.bool: ...
...
class RecordField(_Message):
    ...
    def HasField(self, field_name: _typing.Literal["label", "value"]) -> _builtins.bool: ...
...
class Identifier(_Message):
    ...
    def HasField(self, field_name: _typing.Literal["package_id", "module_name", "entity_name"]) -> _builtins.bool: ...
...
class Variant(_Message):
    ...
    def HasField(self, field_name: _typing.Literal["variant_id", "constructor", "value"]) -> _builtins.bool: ...
...
class Enum(_Message):
    ...
    def HasField(self, field_name: _typing.Literal["enum_id", "constructor"]) -> _builtins.bool: ...
...
class List(_Message):
    ...
    def HasField(self, field_name: _typing.Literal["elements"]) -> _builtins.bool: ...
...
class Optional(_Message):
    ...
    def HasField(self, field_name: _typing.Literal["value"]) -> _builtins.bool: ...
...
class Map(_Message):
    ...
    class Entry(_Message):
        ...
        def HasField(self, field_name: _typing.Literal["key", "value"]) -> _builtins.bool: ...
    ...
    def HasField(self, field_name: _typing.Literal["entries"]) -> _builtins.bool: ...
