...
_PRIMLIT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='numeric', full_name='daml_lf_1.PrimLit.numeric', index=6,
...
_EXPR = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='to_any', full_name='daml_lf_1.Expr.to_any', index=26,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='from_any', full_name='daml_lf_1.Expr.from_any', index=27,
  ...
  nested_types=[_EXPR_RECCON, _EXPR_RECPROJ, _EXPR_RECUPD, _EXPR_VARIANTCON, _EXPR_ENUMCON, _EXPR_TUPLECON, _EXPR_TUPLEPROJ, _EXPR_TUPLEUPD, _EXPR_APP, _EXPR_TYAPP, _EXPR_ABS, _EXPR_TYABS, _EXPR_NIL, _EXPR_CONS, _EXPR_OPTIONALNONE, _EXPR_OPTIONALSOME, _EXPR_TOANY, _EXPR_FROMANY, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
