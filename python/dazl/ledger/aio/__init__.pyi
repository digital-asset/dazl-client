...
class QueryStream(_QueryStream, Protocol):
    ...
    async def close(self) -> None: ...
    # PyCharm seems to have a byg with __aenter__ and __aexit__ being defined as async methods;
    # a return type with Awaitable, however, accomplishes the same thing
