...
class Type:
    ...
    class Fun:
        __match_args__ = ("params", "result")
        @property
        def params(self) -> _typing.Tuple[Type, ...]: ...
        @property
        def result(self) -> Type: ...
        def __init__(self, params: _typing.Iterable[Type], result: Type): ...
    # noinspection PyShadowingBuiltins,SpellCheckingInspection
    class Forall:
...
class Expr:
    ...
    class RecCon:
        ...
        def __init__(self, tycon: Type.Con, fields: _typing.Iterable[FieldWithExpr]): ...
    # noinspection PyShadowingBuiltins,SpellCheckingInspection
    class RecProj:
    ...
    @_typing.overload
    def __init__(self, *, var: str = ..., location: _typing.Optional[Location] = ...): ...
    @_typing.overload
    def __init__(self, *, val: ValName = ..., location: _typing.Optional[Location] = ...): ...
    @_typing.overload
    def __init__(
        self, *, builtin: BuiltinFunction = ..., location: _typing.Optional[Location] = ...
    ): ...
    @_typing.overload
    def __init__(self, *, prim_con: PrimCon = ..., location: _typing.Optional[Location] = ...): ...
    @_typing.overload
    def __init__(self, *, prim_lit: PrimLit = ..., location: _typing.Optional[Location] = ...): ...
    @_typing.overload
    def __init__(
    ...
    @_typing.overload
    def __init__(
        self, *, rec_proj: Expr.RecProj = ..., location: _typing.Optional[Location] = ...
    ): ...
    @_typing.overload
    def __init__(
    ...
    @_typing.overload
    def __init__(
        self, *, variant_con: Expr.VariantCon = ..., location: _typing.Optional[Location] = ...
    ): ...
    @_typing.overload
    def __init__(
        self, *, enum_con: Expr.EnumCon = ..., location: _typing.Optional[Location] = ...
    ): ...
    @_typing.overload
    def __init__(
        self, *, struct_con: Expr.StructCon = ..., location: _typing.Optional[Location] = ...
    ): ...
    @_typing.overload
    def __init__(
        self, *, struct_proj: Expr.StructProj = ..., location: _typing.Optional[Location] = ...
    ): ...
    @_typing.overload
    def __init__(
        self, *, struct_upd: Expr.StructUpd = ..., location: _typing.Optional[Location] = ...
    ): ...
    @_typing.overload
    def __init__(self, *, app: Expr.App = ..., location: _typing.Optional[Location] = ...): ...
    @_typing.overload
    def __init__(self, *, ty_app: Expr.TyApp = ..., location: _typing.Optional[Location] = ...): ...
    @_typing.overload
    def __init__(self, *, abs: Expr.Abs = ..., location: _typing.Optional[Location] = ...): ...
    @_typing.overload
    def __init__(self, *, ty_abs: Expr.TyAbs = ..., location: _typing.Optional[Location] = ...): ...
    @_typing.overload
    def __init__(self, *, case: Case = ..., location: _typing.Optional[Location] = ...): ...
    @_typing.overload
    def __init__(self, *, let: Block = ..., location: _typing.Optional[Location] = ...): ...
    @_typing.overload
    def __init__(self, *, nil: Expr.Nil = ..., location: _typing.Optional[Location] = ...): ...
    @_typing.overload
    def __init__(self, *, cons: Expr.Cons = ..., location: _typing.Optional[Location] = ...): ...
    @_typing.overload
    def __init__(self, *, update: Update = ..., location: _typing.Optional[Location] = ...): ...
    @_typing.overload
    def __init__(self, *, scenario: Scenario = ..., location: _typing.Optional[Location] = ...): ...
    @_typing.overload
    def __init__(
        self, *, optional_none: Expr.OptionalNone = ..., location: _typing.Optional[Location] = ...
    ): ...
    @_typing.overload
    def __init__(
        self, *, optional_some: Expr.OptionalSome = ..., location: _typing.Optional[Location] = ...
    ): ...
    @_typing.overload
    def __init__(self, *, to_any: Expr.ToAny = ..., location: _typing.Optional[Location] = ...): ...
    @_typing.overload
    def __init__(
        self, *, from_any: Expr.FromAny = ..., location: _typing.Optional[Location] = ...
    ): ...
    @_typing.overload
    def __init__(self, *, type_rep: Type = ..., location: _typing.Optional[Location] = ...): ...
    @_typing.overload
    def __init__(
        self,
        *,
    ...
    @_typing.overload
    def __init__(self, *, throw: Expr.Throw = ..., location: _typing.Optional[Location] = ...): ...
    @_typing.overload
    def __init__(
        self, *, experimental: Expr.Experimental = ..., location: _typing.Optional[Location] = ...
    ): ...
    def Sum_match(
        self,
...
class KeyExpr:
    ...
    class Record:
        ...
        def __init__(self, tycon: Type.Con, fields: _typing.Iterable[KeyExpr.RecordField]): ...
    __match_args__ = ()
    @property
    def Sum(
        self,
...
class DefTemplate:
    ...
    class DefKey:
        ...
        @_typing.overload
        def __init__(self, type: Type, maintainers: Expr, *, complex_key: Expr = ...): ...
        def key_expr_match(
            self,
...
class DefException:
    ...
    def __init__(self, name: DottedName, location: _typing.Optional[Location], message: Expr): ...
